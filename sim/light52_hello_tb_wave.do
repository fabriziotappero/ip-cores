...
add wave -noupdate -expand -group SFR
...
add wave -noupdate -format Logic /light52_tb/uut/uart/rd_i
add wave -noupdate -format Logic /light52_tb/uut/uart/wr_i
add wave -noupdate -format Logic /light52_tb/uut/uart/ce_i
add wave -noupdate -format Literal /light52_tb/uut/uart/addr_i
add wave -noupdate -format Literal -radix ascii /light52_tb/uut/uart/data_i
add wave -noupdate -format Logic /light52_tb/uut/uart/load_tx_reg
add wave -noupdate -format Literal -radix ascii /light52_tb/uut/uart/tx_data
add wave -noupdate -format Logic /light52_tb/txd
add wave -noupdate -format Logic /light52_tb/rxd
...
update
WaveRestoreZoom {0 ps} {44152500 ps}
