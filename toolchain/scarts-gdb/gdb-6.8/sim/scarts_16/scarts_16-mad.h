...
#ifndef __SCARTS_16_MAD_H__
#define __SCARTS_16_MAD_H__
...
extern enum scarts_mem_type scarts_lma_decode (uint16_t lma,
...
extern enum scarts_mem_type scarts_codemem_vma_decode (uint16_t vma,
                                                       scarts_codemem_read_fptr_t *read_fptr,
                                                       scarts_codemem_write_fptr_t *write_fptr,
                                                       uint16_t *addr);

extern enum scarts_mem_type scarts_datamem_vma_decode (uint16_t vma,
