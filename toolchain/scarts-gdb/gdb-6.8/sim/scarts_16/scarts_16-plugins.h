...
#ifndef __SCARTS_16_PLUGINS_H__
#define __SCARTS_16_PLUGINS_H__
...
typedef void     (*scarts_plugin_get_mem_map)              (uint16_t *addr,   uint16_t *size);
typedef uint8_t* (*scarts_plugin_get_status_fptr_t)        (void);
typedef int      (*scarts_plugin_mem_read_fptr_t)          (uint16_t offset, uint8_t *value);
typedef int      (*scarts_plugin_mem_write_fptr_t)         (uint16_t offset, uint8_t value);
...
typedef void     (*scarts_plugin_tick_fptr_t)              (uint16_t pc);
