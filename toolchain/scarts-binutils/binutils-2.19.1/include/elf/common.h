...
/* SCARTS_16 ELF backend. Written in the absence of an ABI. */
#define EM_SCARTS_16              0x4F0C

/* SCARTS_32 ELF backend. Written in the absence of an ABI. */
#define EM_SCARTS_32              0x4F1C
