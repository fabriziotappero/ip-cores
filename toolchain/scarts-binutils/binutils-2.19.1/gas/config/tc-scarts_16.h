...
#define md_apply_fix			scarts_16_md_apply_fix
...
extern int scarts_16_force_relocation (struct fix *);
#define TC_FORCE_RELOCATION(FIX) scarts_16_force_relocation(FIX)
