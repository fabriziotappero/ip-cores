...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k "$QSYS_SIMDIR/submodules/sdram_up_clocks_0.v"                     -work up_clocks_0     
  vlogan +v2k "$QSYS_SIMDIR/submodules/sdram_sdram_controller_test_component.v" -work sdram_controller
  vlogan +v2k "$QSYS_SIMDIR/submodules/sdram_sdram_controller.v"                -work sdram_controller
  vlogan +v2k "$QSYS_SIMDIR/sdram.v"                                                                  
fi
