...
# Memory: onchip_0
MEM_0 := vga_soc_onchip_0
$(MEM_0)_NAME := onchip_0
...
$(MEM_0)_START := 0x00028000
$(MEM_0)_END := 0x0002ffff
$(MEM_0)_HIERARCHICAL_PATH := onchip_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_0
onchip_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
