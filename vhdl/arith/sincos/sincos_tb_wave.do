...
add wave -noupdate -format Literal -height 28 -radix decimal /sincos_tb/u_sin/i
add wave -noupdate -format Literal -height 28 -radix decimal /sincos_tb/u_sin/piped_i
add wave -noupdate -format Literal -height 28 -radix unsigned /sincos_tb/u_sin/rom_address
add wave -noupdate -format Literal -height 28 -radix unsigned /sincos_tb/u_sin/abs_sin
add wave -noupdate -format Literal -height 28 -radix unsigned /sincos_tb/u_sin/piped_abs_sin
add wave -noupdate -format Literal -height 28 -radix decimal /sincos_tb/u_sin/sinout
...
WaveRestoreCursors {{Cursor 1} {171548027 ps} 0} {{Cursor 2} {2586899 ps} 0} {{Cursor 3} {1617751 ps} 0}
