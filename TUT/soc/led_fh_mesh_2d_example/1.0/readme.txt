...
HW structure:
	Mesh_2d network with 16 terminals.
...
Directories
	...
	Note that VHDL for the mesh_2d and interfaces to switches/leds are elsewhere.	
...
Usage in Kactus:
	...
	Browse the library and locate "TUT::soc::led_fh_mesh_2d_example::1.0"
...
Usage after/without Kactus:
	...
	a) > File -> Open Project -> ./quartus/led_fh_mesh_2d_example.qpf
