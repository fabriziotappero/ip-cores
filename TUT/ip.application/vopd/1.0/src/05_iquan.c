...
const int REMOTE1  = 7;
const int TX_PORT1 = 12;
const int RX_PORT1 = 13;
const int TX_DATA1 = 365;//568;


const int IN_PORT1  = 9;
const int IN_PORT2  = 11;
...
int main(int argc, char* argv[])
{
   ...
   while(1) {
      ...
      sprintf(outgoing1, "Node %d: iquan (%d)", LOCAL, count);
