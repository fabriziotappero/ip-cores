 ...
 *
 * Instantiates hibiv3_r4.vhd VHDL component for SystemC. 
 * hibi wrapper_r4 has
 *   - one muxed IP interface for regular and hi-prior data
 *   - IP writes/gets addr and data sequentially
 *
 * $Id: hibiv3_r4.hh 2002 2011-10-04 13:18:30Z ege $
 *
 */


#ifndef _HUUHAA_hibiv3_r4_
#define _HUUHAA_hibiv3_r4_
...
template<int id_width_g, 
	 ...
	 int n_segments_g,
	 int separate_addr_g>
class hibiv3_r4 : public sc_foreign_module
{
public:
   sc_in_clk                                         clk_ip;
   sc_in_clk                                         clk_noc;
   ...
   sc_in<sc_bv<n_agents_g - 1 + 1> >                 agent_av_in;
   ...
   sc_out<sc_bv<n_agents_g - 1 + 1> >                agent_av_out;
   ...
   hibiv3_r4(sc_module_name nm, const char* hdl_name)
