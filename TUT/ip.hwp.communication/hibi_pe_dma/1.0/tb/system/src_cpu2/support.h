...
#define HIBI_PE_DMA_BASE (0x80000000 | HIBI_PE_DMA_2_BASE)
#define HIBI_PE_DMA_IRQ_INTERRUPT_CONTROLLER_ID HIBI_PE_DMA_2_IRQ_INTERRUPT_CONTROLLER_ID
#define HIBI_PE_DMA_IRQ HIBI_PE_DMA_2_IRQ
