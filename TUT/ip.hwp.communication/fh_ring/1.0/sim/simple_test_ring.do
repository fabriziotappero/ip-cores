...
vcom -check_synthesis -pedantic ../../ring/vhd/ring_router.vhd
vcom -check_synthesis -pedantic ../../ring/vhd/ring.vhd
vcom -check_synthesis -pedantic ../../ring/vhd/ring_with_pkt_codec_top.vhd

vcom -check_synthesis -pedantic simple_test_ring.vhd

vsim -novopt simple_test_ring
