...
-- /___/   /\     Timestamp: Tue Jul 14 13:39:48 2009
-- \   \  /  \ 
--  \___\/\___\
--             
...
architecture STRUCTURE of comp_eq_111111 is
  signal BU2_U0_gen_structure_logic_gen_nonpipelined_a_equal_notequal_b_i_a_eq_ne_b_result : STD_LOGIC; 
...
begin
  ...
  BU2_U0_gen_structure_logic_gen_nonpipelined_a_equal_notequal_b_i_a_eq_ne_b_result_cmp_eq00001 : LUT6
    generic map(
    ...
    port map (
      ...
      I4 => a_2(4),
      I5 => a_2(5),
      O => BU2_U0_gen_structure_logic_gen_nonpipelined_a_equal_notequal_b_i_a_eq_ne_b_result
    );
  BU2_U0_gen_structure_logic_gen_nonpipelined_a_equal_notequal_b_i_a_eq_ne_b_gen_output_reg_output_reg_fd_output_1 : FDR
    ...
    port map (
      C => clk,
      D => BU2_U0_gen_structure_logic_gen_nonpipelined_a_equal_notequal_b_i_a_eq_ne_b_result,
      R => sclr,
      Q => qa_eq_b
    );
  BU2_XST_GND : GND
