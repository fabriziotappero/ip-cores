...
load_config_help[] =
	"\n"
	"For various reasons, one may wish to keep several different Core\n"
	"configurations available on a single machine.\n"
	"\n"
	"If you have saved a previous configuration in a file other than the\n"
	"Cores's default, entering the name of the file here will allow you\n"
...
save_config_help[] =
	"\n"
	"For various reasons, one may wish to keep different Core\n"
	"configurations available on a single machine.\n"
	"\n"
