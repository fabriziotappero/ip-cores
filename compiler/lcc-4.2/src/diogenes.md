%{
#define INTTMP 0x00001f0
#define INTVAR 0x0003e00
...
rc5: CNSTI4         "%a"                range(a,0,16)
rc5: reg            "$%0"
imm8: CNSTI4		"%a"				range(a,0,255)

imm5p: CNSTI4         "%a"                range(a, 0, 15)

reg: LSHI4(reg, imm5p)  "+shi   r%c, r%0, %1\n"  1
reg: LSHU4(reg, imm5p)  "+shi   r%c, r%0, %1\n"  1
...
stmt: EQI4(reg,reg)  "beq   r%0, r%1, :%a\n"   1
stmt: EQU4(reg,reg)  "beq   r%0, r%1, :%a\n"   1
...
stmt: LTI4(reg,reg)  " cmpl r%t, r%0, r%1\n bz    :%a\n"   1
stmt: LTU4(reg,reg)  "bltu $%0,$%1,%a\n"  1
stmt: NEI4(reg,reg)  "bne   r%0, r%1, :%a\n"   1
stmt: NEU4(reg,reg)  "bne   r%0, r%1, :%a\n"   1
...
reg:  CALLF4(reg)  " call  r13, <r%a>\n nop\n"  2
reg:  CALLF8(reg)  " call  r13, <r%a>\n nop\n"  2
reg:  CALLI4(reg)  " call  r13, <r%a>\n nop\n"  2
reg:  CALLP4(reg)  " call  r13, <r%a>\n nop\n"  2
reg:  CALLU4(reg)  " call  r13, <r%a>\n nop\n"  2
stmt: CALLV(reg)  " call  r13, <r%a>\n nop\n"  2
...
static void function(Symbol f, Symbol caller[], Symbol callee[], int ncalls) {
        ...
        usedmask[IREG] &= 0x0000c00f;   // FIXME
...
static char rcsid[] = "$Id: diogenes.md,v 1.1.1.1 2008-01-24 12:10:04 fellnhofer Exp $";
