...
set_module_property NAME floppy
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP ao486
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME floppy
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL floppy
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file floppy.v VERILOG PATH floppy.v TOP_LEVEL_FILE
...
add_interface_port sd_slave sd_slave_readdata readdata Output 8
add_interface_port sd_slave sd_slave_write write Input 1
add_interface_port sd_slave sd_slave_writedata writedata Input 8
...
add_interface_port conduit_dma_floppy dma_floppy_req export Output 1
add_interface_port conduit_dma_floppy dma_floppy_ack export Input 1
add_interface_port conduit_dma_floppy dma_floppy_terminal export Input 1
add_interface_port conduit_dma_floppy dma_floppy_readdata export Input 8
add_interface_port conduit_dma_floppy dma_floppy_writedata export Output 8
...
add_interface_port conduit_ide_3f6 ide_3f6_read export Output 1
add_interface_port conduit_ide_3f6 ide_3f6_readdata export Input 8
add_interface_port conduit_ide_3f6 ide_3f6_write export Output 1
add_interface_port conduit_ide_3f6 ide_3f6_writedata export Output 8
