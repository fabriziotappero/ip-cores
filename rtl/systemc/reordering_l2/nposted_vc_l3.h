...
#ifndef NPOSTED_VC_L3_H
#define NPOSTED_VC_L3_H

#include "../core_synth/synth_datatypes.h"
#include "../core_synth/constants.h"

/// Request Virtual Channel
/** Used for Non Posted Command (NPC)
	This module stores and reorganizes non-posted packets.
	The most important/recent packet is sent to the output buffer when
	it is free.
*/
class nposted_vc_l3: public sc_module
{
public:
...
public:
	...
	*/
	...
	/// Basic constructor
	nposted_vc_l3(sc_module_name name);
