...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: floating_point_adder_and_multiplier
    Project category: arithmetic_core
    Project branch: arithmetic_core_floating_point_adder_and_multiplier
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_floating_point_adder_and_multiplier --single-branch https://github.com/fabriziotappero/ip-cores.git
