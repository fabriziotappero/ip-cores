...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: vhdl_file-based_cpu_emulator
    Project category: other
    Project branch: other_vhdl_file-based_cpu_emulator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_vhdl_file-based_cpu_emulator --single-branch https://github.com/fabriziotappero/ip-cores.git
