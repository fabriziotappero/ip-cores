...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nocem_--_network_on_chip_emulator
    Project category: system_on_chip
    Project branch: system_on_chip_nocem_--_network_on_chip_emulator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_nocem_--_network_on_chip_emulator --single-branch https://github.com/fabriziotappero/ip-cores.git
