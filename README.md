...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: diogenes_student_risc_system
    Project category: processor
    Project branch: processor_diogenes_student_risc_system
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_diogenes_student_risc_system --single-branch https://github.com/fabriziotappero/ip-cores.git
