...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: most_network_interface_controller
    Project category: communication_controller
    Project branch: communication_controller_most_network_interface_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_most_network_interface_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
