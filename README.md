...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_slave_to_wb_master
    Project category: system_controller
    Project branch: system_controller_pci_slave_to_wb_master
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_pci_slave_to_wb_master --single-branch https://github.com/fabriziotappero/ip-cores.git
