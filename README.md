...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openrisc_1200_hp_hyper_pipelined_or1200_core
    Project category: processor
    Project branch: processor_openrisc_1200_hp_hyper_pipelined_or1200_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_openrisc_1200_hp_hyper_pipelined_or1200_core --single-branch https://github.com/fabriziotappero/ip-cores.git
