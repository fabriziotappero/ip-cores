...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 6809_and_6309_compatible_core
    Project category: processor
    Project branch: processor_6809_and_6309_compatible_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_6809_and_6309_compatible_core --single-branch https://github.com/fabriziotappero/ip-cores.git
