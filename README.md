...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: avrtinyx61core
    Project category: processor
    Project branch: processor_avrtinyx61core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_avrtinyx61core --single-branch https://github.com/fabriziotappero/ip-cores.git
