...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ieee_802.15.4_core_physical_layer
    Project category: communication_controller
    Project branch: communication_controller_ieee_802.15.4_core_physical_layer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ieee_802.15.4_core_physical_layer --single-branch https://github.com/fabriziotappero/ip-cores.git
