...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jtag_slave-boundaryscan_slave
    Project category: communication_controller
    Project branch: communication_controller_jtag_slave-boundaryscan_slave
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_jtag_slave-boundaryscan_slave --single-branch https://github.com/fabriziotappero/ip-cores.git
