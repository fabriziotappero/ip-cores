...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project branch: communication_controller_rs232_1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_rs232_1 --single-branch https://github.com/fabriziotappero/ip-cores.git
