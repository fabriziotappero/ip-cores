...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: z3-the_zork_cpu
    Project category: processor
    Project branch: processor_z3-the_zork_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_z3-the_zork_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
