...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: external_parallel_port_to_internal_wishbone_master
    Project category: system_controller
    Project branch: system_controller_external_parallel_port_to_internal_wishbone_master
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_external_parallel_port_to_internal_wishbone_master --single-branch https://github.com/fabriziotappero/ip-cores.git
