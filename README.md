...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ieee_802.15.4_crc
    Project category: communication_controller
    Project branch: communication_controller_ieee_802.15.4_crc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ieee_802.15.4_crc --single-branch https://github.com/fabriziotappero/ip-cores.git
