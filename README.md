...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: next186mp3
    Project category: system_on_chip
    Project branch: system_on_chip_next186mp3
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_next186mp3 --single-branch https://github.com/fabriziotappero/ip-cores.git
