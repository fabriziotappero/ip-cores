...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: op2p_openpeertopeer_interface
    Project category: communication_controller
    Project branch: communication_controller_op2p_openpeertopeer_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_op2p_openpeertopeer_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
