...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemverilog_directed_test_bench
    Project category: testing-verification
    Project branch: testing-verification_systemverilog_directed_test_bench
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_systemverilog_directed_test_bench --single-branch https://github.com/fabriziotappero/ip-cores.git
