...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: system-on-chip_wire_socwire
    Project category: system_on_chip
    Project branch: system_on_chip_system-on-chip_wire_socwire
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_system-on-chip_wire_socwire --single-branch https://github.com/fabriziotappero/ip-cores.git
