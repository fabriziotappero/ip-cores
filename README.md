...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: locationpu
    Project category: processor
    Project branch: processor_locationpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_locationpu --single-branch https://github.com/fabriziotappero/ip-cores.git
