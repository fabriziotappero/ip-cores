...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: manchester_decoder_for_wireless
    Project category: communication_controller
    Project branch: communication_controller_manchester_decoder_for_wireless
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_manchester_decoder_for_wireless --single-branch https://github.com/fabriziotappero/ip-cores.git
