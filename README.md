...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ula_chip_for_zx_spectrum
    Project category: video_controller
    Project branch: video_controller_ula_chip_for_zx_spectrum
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_ula_chip_for_zx_spectrum --single-branch https://github.com/fabriziotappero/ip-cores.git
