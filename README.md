...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: adaptive_lms_equalizer
    Project category: dsp_core
    Project branch: dsp_core_adaptive_lms_equalizer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_adaptive_lms_equalizer --single-branch https://github.com/fabriziotappero/ip-cores.git
