...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hardware_load_balancer_for_multi-stage_software_ro
    Project category: arithmetic_core
    Project branch: arithmetic_core_hardware_load_balancer_for_multi-stage_software_ro
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_hardware_load_balancer_for_multi-stage_software_ro --single-branch https://github.com/fabriziotappero/ip-cores.git
