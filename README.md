...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_general_purpose_io
    Project category: other
    Project branch: other_simple_general_purpose_io
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_simple_general_purpose_io --single-branch https://github.com/fabriziotappero/ip-cores.git
