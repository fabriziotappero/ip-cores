...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 100_mb-s_ethernet_mac_layer_switch
    Project category: communication_controller
    Project branch: communication_controller_100_mb-s_ethernet_mac_layer_switch
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_100_mb-s_ethernet_mac_layer_switch --single-branch https://github.com/fabriziotappero/ip-cores.git
