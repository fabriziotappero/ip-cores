...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mips_enhanced
    Project category: processor
    Project branch: processor_mips_enhanced
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mips_enhanced --single-branch https://github.com/fabriziotappero/ip-cores.git
