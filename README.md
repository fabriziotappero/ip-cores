...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: turbo-toy_system_verilog_compiler
    Project category: other
    Project branch: other_turbo-toy_system_verilog_compiler
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_turbo-toy_system_verilog_compiler --single-branch https://github.com/fabriziotappero/ip-cores.git
