...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mjpeg_decoder
    Project category: video_controller
    Project branch: video_controller_mjpeg_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_mjpeg_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
