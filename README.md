...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opencores_application_board_1_oab1
    Project category: prototype_board
    Project branch: prototype_board_opencores_application_board_1_oab1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_opencores_application_board_1_oab1 --single-branch https://github.com/fabriziotappero/ip-cores.git
