...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sayeh_educational_processor
    Project category: processor
    Project branch: processor_sayeh_educational_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_sayeh_educational_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
