...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fixed_point_square_root_recursive_algorithm
    Project category: arithmetic_core
    Project branch: arithmetic_core_fixed_point_square_root_recursive_algorithm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fixed_point_square_root_recursive_algorithm --single-branch https://github.com/fabriziotappero/ip-cores.git
