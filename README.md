...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fast_hadamhard_transforms
    Project category: dsp_core
    Project branch: dsp_core_fast_hadamhard_transforms
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_fast_hadamhard_transforms --single-branch https://github.com/fabriziotappero/ip-cores.git
