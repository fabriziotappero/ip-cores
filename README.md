...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: product_code_iterative_decoder
    Project category: ecc_core
    Project branch: ecc_core_product_code_iterative_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_product_code_iterative_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
