...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fixed_point_arithmetic_modules
    Project category: arithmetic_core
    Project branch: arithmetic_core_fixed_point_arithmetic_modules
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fixed_point_arithmetic_modules --single-branch https://github.com/fabriziotappero/ip-cores.git
