...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fpu_double_vhdl
    Project category: arithmetic_core
    Project branch: arithmetic_core_fpu_double_vhdl
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fpu_double_vhdl --single-branch https://github.com/fabriziotappero/ip-cores.git
