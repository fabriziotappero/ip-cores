...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simpcon-a_simple_soc_interconnect
    Project category: system_on_chip
    Project branch: system_on_chip_simpcon-a_simple_soc_interconnect
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_simpcon-a_simple_soc_interconnect --single-branch https://github.com/fabriziotappero/ip-cores.git
