...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: computer_operating_properly
    Project category: other
    Project branch: other_computer_operating_properly
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_computer_operating_properly --single-branch https://github.com/fabriziotappero/ip-cores.git
