...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: g9_impulse_video_game_system
    Project category: other
    Project branch: other_g9_impulse_video_game_system
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_g9_impulse_video_game_system --single-branch https://github.com/fabriziotappero/ip-cores.git
