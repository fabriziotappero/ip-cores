...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gost_28147-89
    Project category: crypto_core
    Project branch: crypto_core_gost_28147-89
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_gost_28147-89 --single-branch https://github.com/fabriziotappero/ip-cores.git
