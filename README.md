...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cf_cordic
    Project category: arithmetic_core
    Project branch: arithmetic_core_cf_cordic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_cf_cordic --single-branch https://github.com/fabriziotappero/ip-cores.git
