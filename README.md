...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: raggedstone_pci_spartan-3_board
    Project category: prototype_board
    Project branch: prototype_board_raggedstone_pci_spartan-3_board
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_raggedstone_pci_spartan-3_board --single-branch https://github.com/fabriziotappero/ip-cores.git
