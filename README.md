...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: universal_multi-function_cordic
    Project category: arithmetic_core
    Project branch: arithmetic_core_universal_multi-function_cordic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_universal_multi-function_cordic --single-branch https://github.com/fabriziotappero/ip-cores.git
