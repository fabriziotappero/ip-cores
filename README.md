...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tiny_instruction_set_computer
    Project category: processor
    Project branch: processor_tiny_instruction_set_computer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_tiny_instruction_set_computer --single-branch https://github.com/fabriziotappero/ip-cores.git
