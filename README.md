...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ogg_vorbis_encoder-decoder_for_virtex-ii_pro
    Project category: other
    Project branch: other_ogg_vorbis_encoder-decoder_for_virtex-ii_pro
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_ogg_vorbis_encoder-decoder_for_virtex-ii_pro --single-branch https://github.com/fabriziotappero/ip-cores.git
