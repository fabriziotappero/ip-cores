...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: picoblazes_interrupt_controller
    Project category: other
    Project branch: other_picoblazes_interrupt_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_picoblazes_interrupt_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
