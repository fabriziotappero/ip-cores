...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: e1_framer-deframer
    Project category: communication_controller
    Project branch: communication_controller_e1_framer-deframer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_e1_framer-deframer --single-branch https://github.com/fabriziotappero/ip-cores.git
