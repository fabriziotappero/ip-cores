...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project branch: communication_controller_i2c_slave
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i2c_slave --single-branch https://github.com/fabriziotappero/ip-cores.git
