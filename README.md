...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: i2c_controller_wishbone_wrapper
    Project category: system_on_chip
    Project branch: system_on_chip_i2c_controller_wishbone_wrapper
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_i2c_controller_wishbone_wrapper --single-branch https://github.com/fabriziotappero/ip-cores.git
