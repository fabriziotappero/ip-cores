...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: adjustable_frequency_divider
    Project category: other
    Project branch: other_adjustable_frequency_divider
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_adjustable_frequency_divider --single-branch https://github.com/fabriziotappero/ip-cores.git
