...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemc_usb1.1_ip_core
    Project category: communication_controller
    Project branch: communication_controller_systemc_usb1.1_ip_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_systemc_usb1.1_ip_core --single-branch https://github.com/fabriziotappero/ip-cores.git
