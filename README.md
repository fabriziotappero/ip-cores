...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: btc-fpga-miner-open_source_fpga_bitcoin_miner
    Project category: arithmetic_core
    Project branch: arithmetic_core_btc-fpga-miner-open_source_fpga_bitcoin_miner
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_btc-fpga-miner-open_source_fpga_bitcoin_miner --single-branch https://github.com/fabriziotappero/ip-cores.git
