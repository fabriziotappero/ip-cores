...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: firewire_ieee_1394
    Project category: communication_controller
    Project branch: communication_controller_firewire_ieee_1394
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_firewire_ieee_1394 --single-branch https://github.com/fabriziotappero/ip-cores.git
