...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: scarts_processor
    Project category: processor
    Project branch: processor_scarts_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_scarts_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
