...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: memory_cores
    Project category: memory_core
    Project branch: memory_core_memory_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_memory_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
