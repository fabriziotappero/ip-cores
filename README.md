...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: random_number_generator_library
    Project category: library
    Project branch: library_random_number_generator_library
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_random_number_generator_library --single-branch https://github.com/fabriziotappero/ip-cores.git
