...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: i2s_to_parallel_interface
    Project category: communication_controller
    Project branch: communication_controller_i2s_to_parallel_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i2s_to_parallel_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
