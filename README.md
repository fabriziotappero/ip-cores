...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: the_neptune_core
    Project category: processor
    Project branch: processor_the_neptune_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_the_neptune_core --single-branch https://github.com/fabriziotappero/ip-cores.git
