...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jpeg_hardware_compressor
    Project category: video_controller
    Project branch: video_controller_jpeg_hardware_compressor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_jpeg_hardware_compressor --single-branch https://github.com/fabriziotappero/ip-cores.git
