...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 3des_triple_des-des_vhdl
    Project category: crypto_core
    Project branch: crypto_core_3des_triple_des-des_vhdl
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_3des_triple_des-des_vhdl --single-branch https://github.com/fabriziotappero/ip-cores.git
