...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: video_dithering
    Project category: video_controller
    Project branch: video_controller_video_dithering
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_video_dithering --single-branch https://github.com/fabriziotappero/ip-cores.git
