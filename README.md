...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: async-sdm-noc
    Project category: system_on_chip
    Project branch: system_on_chip_async-sdm-noc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_async-sdm-noc --single-branch https://github.com/fabriziotappero/ip-cores.git
