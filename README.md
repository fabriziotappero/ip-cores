...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: russells_paradox
    Project category: other
    Project branch: other_russells_paradox
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_russells_paradox --single-branch https://github.com/fabriziotappero/ip-cores.git
