...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hc11_compatible-gator_uprocessor
    Project category: processor
    Project branch: processor_hc11_compatible-gator_uprocessor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_hc11_compatible-gator_uprocessor --single-branch https://github.com/fabriziotappero/ip-cores.git
