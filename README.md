...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pdp-1_reimplementation
    Project category: system_on_chip
    Project branch: system_on_chip_pdp-1_reimplementation
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_pdp-1_reimplementation --single-branch https://github.com/fabriziotappero/ip-cores.git
