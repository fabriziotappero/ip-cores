...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cordic_core
    Project category: arithmetic_core
    Project branch: arithmetic_core_cordic_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_cordic_core --single-branch https://github.com/fabriziotappero/ip-cores.git
