...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: yacc-yet_another_cpu_cpu
    Project category: processor
    Project branch: processor_yacc-yet_another_cpu_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_yacc-yet_another_cpu_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
