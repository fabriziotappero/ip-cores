...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: vhdl_core_of_ic6821
    Project category: processor
    Project branch: processor_vhdl_core_of_ic6821
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_vhdl_core_of_ic6821 --single-branch https://github.com/fabriziotappero/ip-cores.git
