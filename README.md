...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gh_vhdl_library
    Project category: library
    Project branch: library_gh_vhdl_library
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_gh_vhdl_library --single-branch https://github.com/fabriziotappero/ip-cores.git
