...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: apb_to_i2c
    Project category: communication_controller
    Project branch: communication_controller_apb_to_i2c
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_apb_to_i2c --single-branch https://github.com/fabriziotappero/ip-cores.git
