...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_hd44780_driver
    Project category: other
    Project branch: other_simple_hd44780_driver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_simple_hd44780_driver --single-branch https://github.com/fabriziotappero/ip-cores.git
