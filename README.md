...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ag_6502_soft_core_with_phase-level_accuracy
    Project category: processor
    Project branch: processor_ag_6502_soft_core_with_phase-level_accuracy
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_ag_6502_soft_core_with_phase-level_accuracy --single-branch https://github.com/fabriziotappero/ip-cores.git
