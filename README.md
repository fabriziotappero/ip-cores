...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: embedded_fpga_core
    Project category: system_on_chip
    Project branch: system_on_chip_embedded_fpga_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_embedded_fpga_core --single-branch https://github.com/fabriziotappero/ip-cores.git
