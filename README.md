...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: epp_v1.9
    Project category: communication_controller
    Project branch: communication_controller_epp_v1.9
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_epp_v1.9 --single-branch https://github.com/fabriziotappero/ip-cores.git
