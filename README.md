...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_ahb_matrix
    Project category: system_on_chip
    Project branch: system_on_chip_generic_ahb_matrix
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_generic_ahb_matrix --single-branch https://github.com/fabriziotappero/ip-cores.git
