...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cf_reconfigurable_computing_array
    Project category: coprocessor
    Project branch: coprocessor_cf_reconfigurable_computing_array
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b coprocessor_cf_reconfigurable_computing_array --single-branch https://github.com/fabriziotappero/ip-cores.git
