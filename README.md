...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: utosnet_framework
    Project category: other
    Project branch: other_utosnet_framework
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_utosnet_framework --single-branch https://github.com/fabriziotappero/ip-cores.git
