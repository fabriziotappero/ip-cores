...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sd-mmc-spiflash_fpga_config
    Project category: other
    Project branch: other_sd-mmc-spiflash_fpga_config
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_sd-mmc-spiflash_fpga_config --single-branch https://github.com/fabriziotappero/ip-cores.git
