...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: technologic_systems_ts-7300_fpga_computer
    Project category: prototype_board
    Project branch: prototype_board_technologic_systems_ts-7300_fpga_computer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_technologic_systems_ts-7300_fpga_computer --single-branch https://github.com/fabriziotappero/ip-cores.git
