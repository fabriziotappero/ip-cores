...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pwm-timer-counter_ptc_core
    Project category: other
    Project branch: other_pwm-timer-counter_ptc_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_pwm-timer-counter_ptc_core --single-branch https://github.com/fabriziotappero/ip-cores.git
