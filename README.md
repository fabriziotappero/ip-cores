...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: graphical_lcd_interfaces
    Project category: video_controller
    Project branch: video_controller_graphical_lcd_interfaces
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_graphical_lcd_interfaces --single-branch https://github.com/fabriziotappero/ip-cores.git
