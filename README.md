...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: btcminer-open_source_bitcoin_miner
    Project category: crypto_core
    Project branch: crypto_core_btcminer-open_source_bitcoin_miner
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_btcminer-open_source_bitcoin_miner --single-branch https://github.com/fabriziotappero/ip-cores.git
