...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tiny_spi
    Project category: communication_controller
    Project branch: communication_controller_tiny_spi
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_tiny_spi --single-branch https://github.com/fabriziotappero/ip-cores.git
