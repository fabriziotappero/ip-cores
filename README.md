...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: minimal_pdp8-l_implementation_with_4k_disk_monitor
    Project category: processor
    Project branch: processor_minimal_pdp8-l_implementation_with_4k_disk_monitor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_minimal_pdp8-l_implementation_with_4k_disk_monitor --single-branch https://github.com/fabriziotappero/ip-cores.git
