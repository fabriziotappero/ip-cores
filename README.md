...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: elm_embedded_processor
    Project category: processor
    Project branch: processor_elm_embedded_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_elm_embedded_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
