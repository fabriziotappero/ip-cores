...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: serializer-deserializer_for_audio_fiber_optic
    Project category: communication_controller
    Project branch: communication_controller_serializer-deserializer_for_audio_fiber_optic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_serializer-deserializer_for_audio_fiber_optic --single-branch https://github.com/fabriziotappero/ip-cores.git
