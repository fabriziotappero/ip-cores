...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: signed_integer_divider
    Project category: arithmetic_core
    Project branch: arithmetic_core_signed_integer_divider
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_signed_integer_divider --single-branch https://github.com/fabriziotappero/ip-cores.git
