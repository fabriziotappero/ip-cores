...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: reduced_avr_core_for_cpld
    Project category: processor
    Project branch: processor_reduced_avr_core_for_cpld
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_reduced_avr_core_for_cpld --single-branch https://github.com/fabriziotappero/ip-cores.git
