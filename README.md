...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: floating_point_unit
    Project category: coprocessor
    Project branch: coprocessor_floating_point_unit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b coprocessor_floating_point_unit --single-branch https://github.com/fabriziotappero/ip-cores.git
