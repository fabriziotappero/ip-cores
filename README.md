...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_bfm
    Project category: processor
    Project branch: processor_wishbone_bfm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_wishbone_bfm --single-branch https://github.com/fabriziotappero/ip-cores.git
