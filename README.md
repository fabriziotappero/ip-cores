...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jpeg_encoder_verilog
    Project category: video_controller
    Project branch: video_controller_jpeg_encoder_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_jpeg_encoder_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
