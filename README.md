...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: general-purpose_pulse-processing_algorithm
    Project category: other
    Project branch: other_general-purpose_pulse-processing_algorithm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_general-purpose_pulse-processing_algorithm --single-branch https://github.com/fabriziotappero/ip-cores.git
