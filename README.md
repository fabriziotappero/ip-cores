...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: secure_hash_standard_256_bits
    Project category: crypto_core
    Project branch: crypto_core_secure_hash_standard_256_bits
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_secure_hash_standard_256_bits --single-branch https://github.com/fabriziotappero/ip-cores.git
