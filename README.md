...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 16-bit_cpu_based_loosely_on_caxton_fosters_blue_ar
    Project category: processor
    Project branch: processor_16-bit_cpu_based_loosely_on_caxton_fosters_blue_ar
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_16-bit_cpu_based_loosely_on_caxton_fosters_blue_ar --single-branch https://github.com/fabriziotappero/ip-cores.git
