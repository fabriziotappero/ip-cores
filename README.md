...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: small_x86_subset_core
    Project category: processor
    Project branch: processor_small_x86_subset_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_small_x86_subset_core --single-branch https://github.com/fabriziotappero/ip-cores.git
