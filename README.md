...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: vhdl_8254_timer
    Project category: other
    Project branch: other_vhdl_8254_timer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_vhdl_8254_timer --single-branch https://github.com/fabriziotappero/ip-cores.git
