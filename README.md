...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 16x2_lcd_controller
    Project category: other
    Project branch: other_16x2_lcd_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_16x2_lcd_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
