...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: next186_soc_pc
    Project category: system_on_chip
    Project branch: system_on_chip_next186_soc_pc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_next186_soc_pc --single-branch https://github.com/fabriziotappero/ip-cores.git
