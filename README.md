...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: miniga-high_quality_pal_encoder
    Project category: video_controller
    Project branch: video_controller_miniga-high_quality_pal_encoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_miniga-high_quality_pal_encoder --single-branch https://github.com/fabriziotappero/ip-cores.git
