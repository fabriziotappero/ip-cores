...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtftextcontroller
    Project category: video_controller
    Project branch: video_controller_rtftextcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_rtftextcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
