...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: modbus_implementation_in_vhdl
    Project category: arithmetic_core
    Project branch: arithmetic_core_modbus_implementation_in_vhdl
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_modbus_implementation_in_vhdl --single-branch https://github.com/fabriziotappero/ip-cores.git
