...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb_to_uart
    Project category: communication_controller
    Project branch: communication_controller_usb_to_uart
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_usb_to_uart --single-branch https://github.com/fabriziotappero/ip-cores.git
