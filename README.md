...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: system-on-chip_maker
    Project category: other
    Project branch: other_system-on-chip_maker
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_system-on-chip_maker --single-branch https://github.com/fabriziotappero/ip-cores.git
