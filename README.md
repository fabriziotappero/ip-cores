...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: unsigned_serial_divider
    Project category: arithmetic_core
    Project branch: arithmetic_core_unsigned_serial_divider
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_unsigned_serial_divider --single-branch https://github.com/fabriziotappero/ip-cores.git
