...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: srdy-drdy_library
    Project category: library
    Project branch: library_srdy-drdy_library
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_srdy-drdy_library --single-branch https://github.com/fabriziotappero/ip-cores.git
