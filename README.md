...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: double_fpu_verilog
    Project category: arithmetic_core
    Project branch: arithmetic_core_double_fpu_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_double_fpu_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
