...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sha3_keccak
    Project category: crypto_core
    Project branch: crypto_core_sha3_keccak
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_sha3_keccak --single-branch https://github.com/fabriziotappero/ip-cores.git
