...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb_1.1_host_and_function_ip_core
    Project category: communication_controller
    Project branch: communication_controller_usb_1.1_host_and_function_ip_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_usb_1.1_host_and_function_ip_core --single-branch https://github.com/fabriziotappero/ip-cores.git
