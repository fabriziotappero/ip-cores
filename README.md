...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spartan_6_+_pic32_+_usb_+_ethernet
    Project category: prototype_board
    Project branch: prototype_board_spartan_6_+_pic32_+_usb_+_ethernet
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_spartan_6_+_pic32_+_usb_+_ethernet --single-branch https://github.com/fabriziotappero/ip-cores.git
