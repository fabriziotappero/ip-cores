...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fpga_communication_framework
    Project category: communication_controller
    Project branch: communication_controller_fpga_communication_framework
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_fpga_communication_framework --single-branch https://github.com/fabriziotappero/ip-cores.git
