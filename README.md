...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: qaztronics_libraries
    Project category: library
    Project branch: library_qaztronics_libraries
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_qaztronics_libraries --single-branch https://github.com/fabriziotappero/ip-cores.git
