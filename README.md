...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dragonball-68k_wishbone_interface
    Project category: other
    Project branch: other_dragonball-68k_wishbone_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_dragonball-68k_wishbone_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
