...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mcadams_risc_computer_architecture
    Project category: processor
    Project branch: processor_mcadams_risc_computer_architecture
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mcadams_risc_computer_architecture --single-branch https://github.com/fabriziotappero/ip-cores.git
