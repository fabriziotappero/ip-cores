...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cf_state_space_processor
    Project category: processor
    Project branch: processor_cf_state_space_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_cf_state_space_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
