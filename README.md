...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cpu65c02_tc-r65c02_processor_soft_core_with_accura
    Project category: processor
    Project branch: processor_cpu65c02_tc-r65c02_processor_soft_core_with_accura
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_cpu65c02_tc-r65c02_processor_soft_core_with_accura --single-branch https://github.com/fabriziotappero/ip-cores.git
