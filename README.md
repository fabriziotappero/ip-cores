...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pipelined_fft-ifft_128_points_processor
    Project category: dsp_core
    Project branch: dsp_core_pipelined_fft-ifft_128_points_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_pipelined_fft-ifft_128_points_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
