...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project branch: communication_controller_spi_flash_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spi_flash_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
