...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: memory_controller_ip_core
    Project category: system_controller
    Project branch: system_controller_memory_controller_ip_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_memory_controller_ip_core --single-branch https://github.com/fabriziotappero/ip-cores.git
