...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ft816float-floating_point_accelerator
    Project category: arithmetic_core
    Project branch: arithmetic_core_ft816float-floating_point_accelerator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_ft816float-floating_point_accelerator --single-branch https://github.com/fabriziotappero/ip-cores.git
