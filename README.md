...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tg68-execute_68000_code
    Project category: processor
    Project branch: processor_tg68-execute_68000_code
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_tg68-execute_68000_code --single-branch https://github.com/fabriziotappero/ip-cores.git
