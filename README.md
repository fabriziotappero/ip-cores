...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: open_jtag_project
    Project category: testing-verification
    Project branch: testing-verification_open_jtag_project
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_open_jtag_project --single-branch https://github.com/fabriziotappero/ip-cores.git
