...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wb_interface_for_ti_5x_dsp_wb2hpi
    Project category: other
    Project branch: other_wb_interface_for_ti_5x_dsp_wb2hpi
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_wb_interface_for_ti_5x_dsp_wb2hpi --single-branch https://github.com/fabriziotappero/ip-cores.git
