...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: uart_to_spi
    Project category: communication_controller
    Project branch: communication_controller_uart_to_spi
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_uart_to_spi --single-branch https://github.com/fabriziotappero/ip-cores.git
