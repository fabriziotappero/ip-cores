...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: open_hitter_for_traded_options_and_futures
    Project category: other
    Project branch: other_open_hitter_for_traded_options_and_futures
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_open_hitter_for_traded_options_and_futures --single-branch https://github.com/fabriziotappero/ip-cores.git
