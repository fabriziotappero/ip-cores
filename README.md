...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: i8255_realisation_in_verilog
    Project category: communication_controller
    Project branch: communication_controller_i8255_realisation_in_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i8255_realisation_in_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
