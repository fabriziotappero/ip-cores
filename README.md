...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: avr_hp_hyper_pipelined_avr_core
    Project category: processor
    Project branch: processor_avr_hp_hyper_pipelined_avr_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_avr_hp_hyper_pipelined_avr_core --single-branch https://github.com/fabriziotappero/ip-cores.git
