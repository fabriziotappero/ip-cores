...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rs_5_3_gf256
    Project category: ecc_core
    Project branch: ecc_core_rs_5_3_gf256
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_rs_5_3_gf256 --single-branch https://github.com/fabriziotappero/ip-cores.git
