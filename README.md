...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spi_core
    Project category: communication_controller
    Project branch: communication_controller_spi_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spi_core --single-branch https://github.com/fabriziotappero/ip-cores.git
