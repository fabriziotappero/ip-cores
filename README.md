...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: programmable_interval_timer
    Project category: other
    Project branch: other_programmable_interval_timer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_programmable_interval_timer --single-branch https://github.com/fabriziotappero/ip-cores.git
