...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pcie_ds_dma
    Project category: system_controller
    Project branch: system_controller_pcie_ds_dma
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_pcie_ds_dma --single-branch https://github.com/fabriziotappero/ip-cores.git
