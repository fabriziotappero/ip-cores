...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: parametrized_fifo_based_on_srl16e
    Project category: memory_core
    Project branch: memory_core_parametrized_fifo_based_on_srl16e
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_parametrized_fifo_based_on_srl16e --single-branch https://github.com/fabriziotappero/ip-cores.git
