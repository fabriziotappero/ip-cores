...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtf68ksys
    Project category: system_on_chip
    Project branch: system_on_chip_rtf68ksys
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_rtf68ksys --single-branch https://github.com/fabriziotappero/ip-cores.git
