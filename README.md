...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lcd162b_behavior_model
    Project category: arithmetic_core
    Project branch: arithmetic_core_lcd162b_behavior_model
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_lcd162b_behavior_model --single-branch https://github.com/fabriziotappero/ip-cores.git
