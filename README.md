...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hicovec-a_configurable_simd_cpu
    Project category: processor
    Project branch: processor_hicovec-a_configurable_simd_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_hicovec-a_configurable_simd_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
