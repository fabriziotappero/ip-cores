...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: virtual_rs232_terminal_with_lvds_lcd_controller
    Project category: other
    Project branch: other_virtual_rs232_terminal_with_lvds_lcd_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_virtual_rs232_terminal_with_lvds_lcd_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
