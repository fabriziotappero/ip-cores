...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: common_design_environment
    Project category: library
    Project branch: library_common_design_environment
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_common_design_environment --single-branch https://github.com/fabriziotappero/ip-cores.git
