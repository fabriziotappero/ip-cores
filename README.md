...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb_1.1_phy_vhdl
    Project category: communication_controller
    Project branch: communication_controller_usb_1.1_phy_vhdl
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_usb_1.1_phy_vhdl --single-branch https://github.com/fabriziotappero/ip-cores.git
