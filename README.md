...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_ahb_master_stub
    Project category: testing-verification
    Project branch: testing-verification_generic_ahb_master_stub
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_generic_ahb_master_stub --single-branch https://github.com/fabriziotappero/ip-cores.git
