...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: yellow_star
    Project category: processor
    Project branch: processor_yellow_star
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_yellow_star --single-branch https://github.com/fabriziotappero/ip-cores.git
