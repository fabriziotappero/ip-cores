...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ahb_system_generator
    Project category: system_on_chip
    Project branch: system_on_chip_ahb_system_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_ahb_system_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
