...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: epc_rfid_transponder
    Project category: system_on_chip
    Project branch: system_on_chip_epc_rfid_transponder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_epc_rfid_transponder --single-branch https://github.com/fabriziotappero/ip-cores.git
