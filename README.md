...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: scan_based_serial_communication
    Project category: communication_controller
    Project branch: communication_controller_scan_based_serial_communication
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_scan_based_serial_communication --single-branch https://github.com/fabriziotappero/ip-cores.git
