...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dmt_transceiver
    Project category: communication_controller
    Project branch: communication_controller_dmt_transceiver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_dmt_transceiver --single-branch https://github.com/fabriziotappero/ip-cores.git
