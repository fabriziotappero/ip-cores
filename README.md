...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ternary_3-input_adder
    Project category: arithmetic_core
    Project branch: arithmetic_core_ternary_3-input_adder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_ternary_3-input_adder --single-branch https://github.com/fabriziotappero/ip-cores.git
