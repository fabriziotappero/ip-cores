...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: confluence_openrisc_1000
    Project category: processor
    Project branch: processor_confluence_openrisc_1000
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_confluence_openrisc_1000 --single-branch https://github.com/fabriziotappero/ip-cores.git
