...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: embedded_32-bit_risc_uprocessor_with_sdram_control
    Project category: system_on_chip
    Project branch: system_on_chip_embedded_32-bit_risc_uprocessor_with_sdram_control
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_embedded_32-bit_risc_uprocessor_with_sdram_control --single-branch https://github.com/fabriziotappero/ip-cores.git
