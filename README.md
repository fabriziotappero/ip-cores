...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wb_async_mem_bridge
    Project category: memory_core
    Project branch: memory_core_wb_async_mem_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_wb_async_mem_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
