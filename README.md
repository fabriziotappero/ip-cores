...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: i2c_master_slave_core
    Project category: communication_controller
    Project branch: communication_controller_i2c_master_slave_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i2c_master_slave_core --single-branch https://github.com/fabriziotappero/ip-cores.git
