...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: qrisc32_wishbone_compatible_risc_core
    Project category: processor
    Project branch: processor_qrisc32_wishbone_compatible_risc_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_qrisc32_wishbone_compatible_risc_core --single-branch https://github.com/fabriziotappero/ip-cores.git
