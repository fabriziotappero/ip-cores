...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ws2812_rgb_led_string_driver
    Project category: other
    Project branch: other_ws2812_rgb_led_string_driver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_ws2812_rgb_led_string_driver --single-branch https://github.com/fabriziotappero/ip-cores.git
