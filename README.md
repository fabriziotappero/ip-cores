...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: configurable_high_speed_viterbi_decoder
    Project category: dsp_core
    Project branch: dsp_core_configurable_high_speed_viterbi_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_configurable_high_speed_viterbi_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
