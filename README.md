...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: documented_verilog_uart
    Project category: communication_controller
    Project branch: communication_controller_documented_verilog_uart
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_documented_verilog_uart --single-branch https://github.com/fabriziotappero/ip-cores.git
