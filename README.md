...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: automatic_baud_rate_generator
    Project category: communication_controller
    Project branch: communication_controller_automatic_baud_rate_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_automatic_baud_rate_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
