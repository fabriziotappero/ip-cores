...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: backtracking_sudoku_solver
    Project category: other
    Project branch: other_backtracking_sudoku_solver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_backtracking_sudoku_solver --single-branch https://github.com/fabriziotappero/ip-cores.git
