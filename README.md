...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sharp_lq057q3dc02_lcd_controller
    Project category: video_controller
    Project branch: video_controller_sharp_lq057q3dc02_lcd_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_sharp_lq057q3dc02_lcd_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
