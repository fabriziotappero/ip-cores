...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 10g_ethernet_mac
    Project category: communication_controller
    Project branch: communication_controller_10g_ethernet_mac
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_10g_ethernet_mac --single-branch https://github.com/fabriziotappero/ip-cores.git
