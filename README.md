...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mcpu-a_minimal_cpu_for_a_cpld
    Project category: processor
    Project branch: processor_mcpu-a_minimal_cpu_for_a_cpld
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mcpu-a_minimal_cpu_for_a_cpld --single-branch https://github.com/fabriziotappero/ip-cores.git
