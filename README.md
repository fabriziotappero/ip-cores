...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hcsa_adder_and_generic_alu_based_on_hcsa
    Project category: arithmetic_core
    Project branch: arithmetic_core_hcsa_adder_and_generic_alu_based_on_hcsa
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_hcsa_adder_and_generic_alu_based_on_hcsa --single-branch https://github.com/fabriziotappero/ip-cores.git
