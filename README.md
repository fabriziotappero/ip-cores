...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ieee_802.15.4_crc_check
    Project category: arithmetic_core
    Project branch: arithmetic_core_ieee_802.15.4_crc_check
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_ieee_802.15.4_crc_check --single-branch https://github.com/fabriziotappero/ip-cores.git
