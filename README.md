...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: etherlab-spartan-3e_starterkit_to_cs_to_bridge
    Project category: other
    Project branch: other_etherlab-spartan-3e_starterkit_to_cs_to_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_etherlab-spartan-3e_starterkit_to_cs_to_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
