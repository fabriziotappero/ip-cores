...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: async_8b-10b_enc-dec
    Project category: communication_controller
    Project branch: communication_controller_async_8b-10b_enc-dec
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_async_8b-10b_enc-dec --single-branch https://github.com/fabriziotappero/ip-cores.git
