...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mesi_coherency_intersection_controller
    Project category: arithmetic_core
    Project branch: arithmetic_core_mesi_coherency_intersection_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_mesi_coherency_intersection_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
