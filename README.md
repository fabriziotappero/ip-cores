...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: parameterisable_dram_model
    Project category: memory_core
    Project branch: memory_core_parameterisable_dram_model
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_parameterisable_dram_model --single-branch https://github.com/fabriziotappero/ip-cores.git
