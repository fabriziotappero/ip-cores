...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_ac97_controller
    Project category: other
    Project branch: other_simple_ac97_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_simple_ac97_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
