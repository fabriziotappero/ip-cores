...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: numbert_sort_device_on
    Project category: arithmetic_core
    Project branch: arithmetic_core_numbert_sort_device_on
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_numbert_sort_device_on --single-branch https://github.com/fabriziotappero/ip-cores.git
