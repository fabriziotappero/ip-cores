...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: z80_system_on_chip
    Project category: system_on_chip
    Project branch: system_on_chip_z80_system_on_chip
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_z80_system_on_chip --single-branch https://github.com/fabriziotappero/ip-cores.git
