...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: the_grain_stream_cipher
    Project category: crypto_core
    Project branch: crypto_core_the_grain_stream_cipher
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_the_grain_stream_cipher --single-branch https://github.com/fabriziotappero/ip-cores.git
