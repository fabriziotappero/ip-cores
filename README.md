...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: des-triple_des_ip_cores
    Project category: crypto_core
    Project branch: crypto_core_des-triple_des_ip_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_des-triple_des_ip_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
