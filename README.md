...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dct-discrete_cosine_transformer
    Project category: arithmetic_core
    Project branch: arithmetic_core_dct-discrete_cosine_transformer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_dct-discrete_cosine_transformer --single-branch https://github.com/fabriziotappero/ip-cores.git
