...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: maxii-evalboard
    Project category: prototype_board
    Project branch: prototype_board_maxii-evalboard
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_maxii-evalboard --single-branch https://github.com/fabriziotappero/ip-cores.git
