...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pltbutils
    Project category: testing-verification
    Project branch: testing-verification_pltbutils
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_pltbutils --single-branch https://github.com/fabriziotappero/ip-cores.git
