...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: low_power_fir_filter
    Project category: dsp_core
    Project branch: dsp_core_low_power_fir_filter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_low_power_fir_filter --single-branch https://github.com/fabriziotappero/ip-cores.git
