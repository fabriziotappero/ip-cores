...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: md5_pipelined
    Project category: crypto_core
    Project branch: crypto_core_md5_pipelined
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_md5_pipelined --single-branch https://github.com/fabriziotappero/ip-cores.git
