...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: butterfly_light
    Project category: prototype_board
    Project branch: prototype_board_butterfly_light
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_butterfly_light --single-branch https://github.com/fabriziotappero/ip-cores.git
