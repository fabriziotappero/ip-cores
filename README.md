...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pipelined_fixed_point_elementary_functions_div_si
    Project category: dsp_core
    Project branch: dsp_core_pipelined_fixed_point_elementary_functions_div_si
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_pipelined_fixed_point_elementary_functions_div_si --single-branch https://github.com/fabriziotappero/ip-cores.git
