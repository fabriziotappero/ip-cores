...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ethernet_mac_10-100_mbps
    Project category: communication_controller
    Project branch: communication_controller_ethernet_mac_10-100_mbps
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ethernet_mac_10-100_mbps --single-branch https://github.com/fabriziotappero/ip-cores.git
