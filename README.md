...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wiegand_controller_sia_ac-01-1996.10
    Project category: communication_controller
    Project branch: communication_controller_wiegand_controller_sia_ac-01-1996.10
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_wiegand_controller_sia_ac-01-1996.10 --single-branch https://github.com/fabriziotappero/ip-cores.git
