...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: constellation_encoder
    Project category: ecc_core
    Project branch: ecc_core_constellation_encoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_constellation_encoder --single-branch https://github.com/fabriziotappero/ip-cores.git
