...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: iso7816_3_master
    Project category: communication_controller
    Project branch: communication_controller_iso7816_3_master
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_iso7816_3_master --single-branch https://github.com/fabriziotappero/ip-cores.git
