...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: random_pulse_generator
    Project category: other
    Project branch: other_random_pulse_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_random_pulse_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
