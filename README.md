...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openfpu64
    Project category: arithmetic_core
    Project branch: arithmetic_core_openfpu64
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_openfpu64 --single-branch https://github.com/fabriziotappero/ip-cores.git
