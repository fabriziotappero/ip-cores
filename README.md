...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: z80control
    Project category: processor
    Project branch: processor_z80control
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_z80control --single-branch https://github.com/fabriziotappero/ip-cores.git
