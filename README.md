...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: salsa20streamcipher
    Project category: crypto_core
    Project branch: crypto_core_salsa20streamcipher
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_salsa20streamcipher --single-branch https://github.com/fabriziotappero/ip-cores.git
