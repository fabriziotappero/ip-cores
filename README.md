...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hdb3-b3zs_encoder+decoder
    Project category: communication_controller
    Project branch: communication_controller_hdb3-b3zs_encoder+decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_hdb3-b3zs_encoder+decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
