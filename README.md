...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: configurable_crc_core
    Project category: arithmetic_core
    Project branch: arithmetic_core_configurable_crc_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_configurable_crc_core --single-branch https://github.com/fabriziotappero/ip-cores.git
