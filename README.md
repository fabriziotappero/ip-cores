...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemverilog_uart16550
    Project category: communication_controller
    Project branch: communication_controller_systemverilog_uart16550
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_systemverilog_uart16550 --single-branch https://github.com/fabriziotappero/ip-cores.git
