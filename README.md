...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: real-time_clock
    Project category: library
    Project branch: library_real-time_clock
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_real-time_clock --single-branch https://github.com/fabriziotappero/ip-cores.git
