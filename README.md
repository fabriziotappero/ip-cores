...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: potato_processor
    Project category: processor
    Project branch: processor_potato_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_potato_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
