...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ima_adpcm_sound_encoder
    Project category: other
    Project branch: other_ima_adpcm_sound_encoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_ima_adpcm_sound_encoder --single-branch https://github.com/fabriziotappero/ip-cores.git
