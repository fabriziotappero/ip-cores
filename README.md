...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: floating-point_logarithm_unit
    Project category: arithmetic_core
    Project branch: arithmetic_core_floating-point_logarithm_unit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_floating-point_logarithm_unit --single-branch https://github.com/fabriziotappero/ip-cores.git
