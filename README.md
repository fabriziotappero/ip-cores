...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tiny_tate_bilinear_pairing
    Project category: arithmetic_core
    Project branch: arithmetic_core_tiny_tate_bilinear_pairing
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_tiny_tate_bilinear_pairing --single-branch https://github.com/fabriziotappero/ip-cores.git
