...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: keyboardcontroller
    Project category: other
    Project branch: other_keyboardcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_keyboardcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
