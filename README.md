...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: color_converter
    Project category: video_controller
    Project branch: video_controller_color_converter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_color_converter --single-branch https://github.com/fabriziotappero/ip-cores.git
