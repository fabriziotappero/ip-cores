...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: assembler_with_vhdl_user-defined_commands_avuc
    Project category: system_on_chip
    Project branch: system_on_chip_assembler_with_vhdl_user-defined_commands_avuc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_assembler_with_vhdl_user-defined_commands_avuc --single-branch https://github.com/fabriziotappero/ip-cores.git
