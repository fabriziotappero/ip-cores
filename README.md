...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_flash_interface_for_parallel_flash
    Project category: memory_core
    Project branch: memory_core_wishbone_flash_interface_for_parallel_flash
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_wishbone_flash_interface_for_parallel_flash --single-branch https://github.com/fabriziotappero/ip-cores.git
