...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: reconfigurable_hardware_platform
    Project category: arithmetic_core
    Project branch: arithmetic_core_reconfigurable_hardware_platform
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_reconfigurable_hardware_platform --single-branch https://github.com/fabriziotappero/ip-cores.git
