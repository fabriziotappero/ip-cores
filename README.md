...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jpeg_codec_library_based_on_microblaze
    Project category: video_controller
    Project branch: video_controller_jpeg_codec_library_based_on_microblaze
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_jpeg_codec_library_based_on_microblaze --single-branch https://github.com/fabriziotappero/ip-cores.git
