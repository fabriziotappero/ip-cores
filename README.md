...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: robot_control_library
    Project category: library
    Project branch: library_robot_control_library
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_robot_control_library --single-branch https://github.com/fabriziotappero/ip-cores.git
