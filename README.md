...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: i2c_traffic_logger
    Project category: communication_controller
    Project branch: communication_controller_i2c_traffic_logger
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i2c_traffic_logger --single-branch https://github.com/fabriziotappero/ip-cores.git
