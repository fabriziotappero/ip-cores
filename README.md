...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_register_bank_intercon_multi-master_multi
    Project category: communication_controller
    Project branch: communication_controller_wishbone_register_bank_intercon_multi-master_multi
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_wishbone_register_bank_intercon_multi-master_multi --single-branch https://github.com/fabriziotappero/ip-cores.git
