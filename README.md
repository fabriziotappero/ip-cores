...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: idea_core
    Project category: crypto_core
    Project branch: crypto_core_idea_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_idea_core --single-branch https://github.com/fabriziotappero/ip-cores.git
