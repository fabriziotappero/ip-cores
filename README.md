...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cellular_automata_prng
    Project category: arithmetic_core
    Project branch: arithmetic_core_cellular_automata_prng
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_cellular_automata_prng --single-branch https://github.com/fabriziotappero/ip-cores.git
