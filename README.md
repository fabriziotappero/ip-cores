...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mini-risc_core
    Project category: processor
    Project branch: processor_mini-risc_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mini-risc_core --single-branch https://github.com/fabriziotappero/ip-cores.git
