...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: soft_multiprocessor_on_fpga
    Project category: system_on_chip
    Project branch: system_on_chip_soft_multiprocessor_on_fpga
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_soft_multiprocessor_on_fpga --single-branch https://github.com/fabriziotappero/ip-cores.git
