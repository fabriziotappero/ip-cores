...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: high_speed_sdram_controller_with_adaptive_bank_man
    Project category: memory_core
    Project branch: memory_core_high_speed_sdram_controller_with_adaptive_bank_man
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_high_speed_sdram_controller_with_adaptive_bank_man --single-branch https://github.com/fabriziotappero/ip-cores.git
