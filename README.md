...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: small_stack_based_computer_compiler
    Project category: processor
    Project branch: processor_small_stack_based_computer_compiler
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_small_stack_based_computer_compiler --single-branch https://github.com/fabriziotappero/ip-cores.git
