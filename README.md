...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: educational_risc_processor
    Project category: processor
    Project branch: processor_educational_risc_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_educational_risc_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
