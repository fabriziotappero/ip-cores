...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: extension_pack
    Project category: library
    Project branch: library_extension_pack
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_extension_pack --single-branch https://github.com/fabriziotappero/ip-cores.git
