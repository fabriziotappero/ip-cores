...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dmx512_transceiver
    Project category: communication_controller
    Project branch: communication_controller_dmx512_transceiver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_dmx512_transceiver --single-branch https://github.com/fabriziotappero/ip-cores.git
