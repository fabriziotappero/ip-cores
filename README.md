...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: canny_edge_detector
    Project category: dsp_core
    Project branch: dsp_core_canny_edge_detector
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_canny_edge_detector --single-branch https://github.com/fabriziotappero/ip-cores.git
