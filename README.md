...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hardware_division_units
    Project category: arithmetic_core
    Project branch: arithmetic_core_hardware_division_units
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_hardware_division_units --single-branch https://github.com/fabriziotappero/ip-cores.git
