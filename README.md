...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_core_modules
    Project category: crypto_core
    Project branch: crypto_core_aes_core_modules
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_core_modules --single-branch https://github.com/fabriziotappero/ip-cores.git
