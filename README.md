...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: groundhog_2009-benchmark_suite_for_mobile_applicat
    Project category: other
    Project branch: other_groundhog_2009-benchmark_suite_for_mobile_applicat
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_groundhog_2009-benchmark_suite_for_mobile_applicat --single-branch https://github.com/fabriziotappero/ip-cores.git
