...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sd-mmc_bootloader
    Project category: communication_controller
    Project branch: communication_controller_sd-mmc_bootloader
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_sd-mmc_bootloader --single-branch https://github.com/fabriziotappero/ip-cores.git
