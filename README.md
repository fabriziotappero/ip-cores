...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mpx_32-bit_cpu
    Project category: processor
    Project branch: processor_mpx_32-bit_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mpx_32-bit_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
