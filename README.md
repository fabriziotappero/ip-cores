...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: soc_debug_interface
    Project category: other
    Project branch: other_soc_debug_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_soc_debug_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
