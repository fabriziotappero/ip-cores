...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: scsi_chip
    Project category: system_controller
    Project branch: system_controller_scsi_chip
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_scsi_chip --single-branch https://github.com/fabriziotappero/ip-cores.git
