...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pc-fpga_communication_platform
    Project category: communication_controller
    Project branch: communication_controller_pc-fpga_communication_platform
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_pc-fpga_communication_platform --single-branch https://github.com/fabriziotappero/ip-cores.git
