...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 8051_slave_to_wishbone_master_interface
    Project category: other
    Project branch: other_8051_slave_to_wishbone_master_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_8051_slave_to_wishbone_master_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
