...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: t48_Âµcontroller
    Project category: processor
    Project branch: processor_t48_Âµcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_t48_Âµcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
