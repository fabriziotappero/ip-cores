...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtfsimpleuart
    Project category: communication_controller
    Project branch: communication_controller_rtfsimpleuart
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_rtfsimpleuart --single-branch https://github.com/fabriziotappero/ip-cores.git
