...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ohci_full-low-speed_usb_host_controller
    Project category: communication_controller
    Project branch: communication_controller_ohci_full-low-speed_usb_host_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ohci_full-low-speed_usb_host_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
