...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: minimac-the_minimalist_ethernet_mac
    Project category: communication_controller
    Project branch: communication_controller_minimac-the_minimalist_ethernet_mac
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_minimac-the_minimalist_ethernet_mac --single-branch https://github.com/fabriziotappero/ip-cores.git
