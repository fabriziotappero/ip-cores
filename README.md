...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opb_usblite
    Project category: communication_controller
    Project branch: communication_controller_opb_usblite
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_opb_usblite --single-branch https://github.com/fabriziotappero/ip-cores.git
