...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_encryption_all_keylength
    Project category: crypto_core
    Project branch: crypto_core_aes_encryption_all_keylength
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_encryption_all_keylength --single-branch https://github.com/fabriziotappero/ip-cores.git
