...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pdp-11-70_cpu_core_and_soc
    Project category: processor
    Project branch: processor_pdp-11-70_cpu_core_and_soc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_pdp-11-70_cpu_core_and_soc --single-branch https://github.com/fabriziotappero/ip-cores.git
