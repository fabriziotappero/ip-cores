...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dds_synthesizer
    Project category: dsp_core
    Project branch: dsp_core_dds_synthesizer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_dds_synthesizer --single-branch https://github.com/fabriziotappero/ip-cores.git
