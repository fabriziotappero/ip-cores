...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spi_serial_dac_interface
    Project category: communication_controller
    Project branch: communication_controller_spi_serial_dac_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spi_serial_dac_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
