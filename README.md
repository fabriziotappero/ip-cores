...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gen_vectorial
    Project category: other
    Project branch: other_gen_vectorial
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_gen_vectorial --single-branch https://github.com/fabriziotappero/ip-cores.git
