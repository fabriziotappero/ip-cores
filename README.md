...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mitrion_virtual_processor_starter_kit
    Project category: library
    Project branch: library_mitrion_virtual_processor_starter_kit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_mitrion_virtual_processor_starter_kit --single-branch https://github.com/fabriziotappero/ip-cores.git
