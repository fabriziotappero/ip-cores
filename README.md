...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: real-time_image_processing
    Project category: system_on_chip
    Project branch: system_on_chip_real-time_image_processing
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_real-time_image_processing --single-branch https://github.com/fabriziotappero/ip-cores.git
