...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lightweight_8051_compatible_cpu
    Project category: processor
    Project branch: processor_lightweight_8051_compatible_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_lightweight_8051_compatible_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
