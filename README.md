...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: yanu-uart_with_predictive_interrupt_events_on_rx-t
    Project category: communication_controller
    Project branch: communication_controller_yanu-uart_with_predictive_interrupt_events_on_rx-t
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_yanu-uart_with_predictive_interrupt_events_on_rx-t --single-branch https://github.com/fabriziotappero/ip-cores.git
