...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_system6800-01
    Project category: system_on_chip
    Project branch: system_on_chip_wishbone_system6800-01
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_wishbone_system6800-01 --single-branch https://github.com/fabriziotappero/ip-cores.git
