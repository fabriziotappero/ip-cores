...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cr_div-cached_reciprocal_divider
    Project category: arithmetic_core
    Project branch: arithmetic_core_cr_div-cached_reciprocal_divider
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_cr_div-cached_reciprocal_divider --single-branch https://github.com/fabriziotappero/ip-cores.git
