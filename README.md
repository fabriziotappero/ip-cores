...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: demosaic_bilinear
    Project category: video_controller
    Project branch: video_controller_demosaic_bilinear
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_demosaic_bilinear --single-branch https://github.com/fabriziotappero/ip-cores.git
