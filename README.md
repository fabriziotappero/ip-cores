...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: heap_sorter_for_fpga
    Project category: arithmetic_core
    Project branch: arithmetic_core_heap_sorter_for_fpga
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_heap_sorter_for_fpga --single-branch https://github.com/fabriziotappero/ip-cores.git
