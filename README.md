...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 802.3an_ldpc_decoder
    Project category: ecc_core
    Project branch: ecc_core_802.3an_ldpc_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_802.3an_ldpc_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
