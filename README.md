...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gecko4_soc_co-design_environment
    Project category: system_on_chip
    Project branch: system_on_chip_gecko4_soc_co-design_environment
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_gecko4_soc_co-design_environment --single-branch https://github.com/fabriziotappero/ip-cores.git
