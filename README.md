...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bitwise_addressable_gpio
    Project category: communication_controller
    Project branch: communication_controller_bitwise_addressable_gpio
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_bitwise_addressable_gpio --single-branch https://github.com/fabriziotappero/ip-cores.git
