...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rise_microprocessor
    Project category: processor
    Project branch: processor_rise_microprocessor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_rise_microprocessor --single-branch https://github.com/fabriziotappero/ip-cores.git
