...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hd63701_compatible_core
    Project category: processor
    Project branch: processor_hd63701_compatible_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_hd63701_compatible_core --single-branch https://github.com/fabriziotappero/ip-cores.git
