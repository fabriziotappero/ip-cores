...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lfsr_counter_generator
    Project category: other
    Project branch: other_lfsr_counter_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_lfsr_counter_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
