...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spi_master_receiver_for_adc_ad747x
    Project category: communication_controller
    Project branch: communication_controller_spi_master_receiver_for_adc_ad747x
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spi_master_receiver_for_adc_ad747x --single-branch https://github.com/fabriziotappero/ip-cores.git
