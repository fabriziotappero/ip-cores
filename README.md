...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 1_bit_adpcm_codec
    Project category: arithmetic_core
    Project branch: arithmetic_core_1_bit_adpcm_codec
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_1_bit_adpcm_codec --single-branch https://github.com/fabriziotappero/ip-cores.git
