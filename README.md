...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fuzzy_logic_hardware_accelerator
    Project category: other
    Project branch: other_fuzzy_logic_hardware_accelerator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_fuzzy_logic_hardware_accelerator --single-branch https://github.com/fabriziotappero/ip-cores.git
