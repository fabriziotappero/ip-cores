...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: high_load_configurable_test_project
    Project category: testing-verification
    Project branch: testing-verification_high_load_configurable_test_project
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_high_load_configurable_test_project --single-branch https://github.com/fabriziotappero/ip-cores.git
