...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dna_sequence_alignment_accelerator
    Project category: other
    Project branch: other_dna_sequence_alignment_accelerator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_dna_sequence_alignment_accelerator --single-branch https://github.com/fabriziotappero/ip-cores.git
