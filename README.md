...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ay-3-8910_compatible_module_in_verilog
    Project category: other
    Project branch: other_ay-3-8910_compatible_module_in_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_ay-3-8910_compatible_module_in_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
