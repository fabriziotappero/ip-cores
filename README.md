...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jop_a_java_optimized_processor
    Project category: processor
    Project branch: processor_jop_a_java_optimized_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_jop_a_java_optimized_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
