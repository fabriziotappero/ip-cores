...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ddr2_mem_controller_for_digilent_genesys_board
    Project category: memory_core
    Project branch: memory_core_ddr2_mem_controller_for_digilent_genesys_board
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_ddr2_mem_controller_for_digilent_genesys_board --single-branch https://github.com/fabriziotappero/ip-cores.git
