...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: h.264-avc_baseline_decoder
    Project category: video_controller
    Project branch: video_controller_h.264-avc_baseline_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_h.264-avc_baseline_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
