...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes-128_encryption
    Project category: crypto_core
    Project branch: crypto_core_aes-128_encryption
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes-128_encryption --single-branch https://github.com/fabriziotappero/ip-cores.git
