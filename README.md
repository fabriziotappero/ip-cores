...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gaussian_noise_generator
    Project category: arithmetic_core
    Project branch: arithmetic_core_gaussian_noise_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_gaussian_noise_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
