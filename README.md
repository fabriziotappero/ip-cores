...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_express_x1_16bit_vera_testbench
    Project category: system_controller
    Project branch: system_controller_pci_express_x1_16bit_vera_testbench
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_pci_express_x1_16bit_vera_testbench --single-branch https://github.com/fabriziotappero/ip-cores.git
