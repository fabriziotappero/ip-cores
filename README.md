...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: parallel_crc_generator
    Project category: other
    Project branch: other_parallel_crc_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_parallel_crc_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
