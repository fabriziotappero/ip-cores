...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ti_dsp_and_xilinx_fpga_dev_board
    Project category: system_controller
    Project branch: system_controller_ti_dsp_and_xilinx_fpga_dev_board
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_ti_dsp_and_xilinx_fpga_dev_board --single-branch https://github.com/fabriziotappero/ip-cores.git
