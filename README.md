...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lattice_6502
    Project category: processor
    Project branch: processor_lattice_6502
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_lattice_6502 --single-branch https://github.com/fabriziotappero/ip-cores.git
