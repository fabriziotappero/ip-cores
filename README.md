...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: zet-the_x86_ia-32_open_implementation
    Project category: processor
    Project branch: processor_zet-the_x86_ia-32_open_implementation
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_zet-the_x86_ia-32_open_implementation --single-branch https://github.com/fabriziotappero/ip-cores.git
