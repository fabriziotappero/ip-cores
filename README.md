...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_high_performance_z80
    Project category: processor
    Project branch: processor_wishbone_high_performance_z80
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_wishbone_high_performance_z80 --single-branch https://github.com/fabriziotappero/ip-cores.git
