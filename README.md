...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cic-filter_core
    Project category: dsp_core
    Project branch: dsp_core_cic-filter_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_cic-filter_core --single-branch https://github.com/fabriziotappero/ip-cores.git
