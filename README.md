...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: elliptic_curve_group
    Project category: arithmetic_core
    Project branch: arithmetic_core_elliptic_curve_group
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_elliptic_curve_group --single-branch https://github.com/fabriziotappero/ip-cores.git
