...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_sd_card_controller
    Project category: communication_controller
    Project branch: communication_controller_wishbone_sd_card_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_wishbone_sd_card_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
