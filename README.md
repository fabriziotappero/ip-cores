...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: npi_graphics_controller
    Project category: video_controller
    Project branch: video_controller_npi_graphics_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_npi_graphics_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
