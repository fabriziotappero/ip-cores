...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hive-a_32_bit_8_thread_4_register-stack_hybrid_pip
    Project category: processor
    Project branch: processor_hive-a_32_bit_8_thread_4_register-stack_hybrid_pip
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_hive-a_32_bit_8_thread_4_register-stack_hybrid_pip --single-branch https://github.com/fabriziotappero/ip-cores.git
