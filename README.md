...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: true_matrix_3x3_multiplier
    Project category: arithmetic_core
    Project branch: arithmetic_core_true_matrix_3x3_multiplier
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_true_matrix_3x3_multiplier --single-branch https://github.com/fabriziotappero/ip-cores.git
