...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: vtach-bell_labs_cardiac_reimagined_in_verilog
    Project category: processor
    Project branch: processor_vtach-bell_labs_cardiac_reimagined_in_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_vtach-bell_labs_cardiac_reimagined_in_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
