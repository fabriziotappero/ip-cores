...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_axi_to_apb_bridge
    Project category: system_on_chip
    Project branch: system_on_chip_generic_axi_to_apb_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_generic_axi_to_apb_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
