...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: double_clocked_fft_core
    Project category: dsp_core
    Project branch: dsp_core_double_clocked_fft_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_double_clocked_fft_core --single-branch https://github.com/fabriziotappero/ip-cores.git
