...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: atlas_processor_core
    Project category: processor
    Project branch: processor_atlas_processor_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_atlas_processor_core --single-branch https://github.com/fabriziotappero/ip-cores.git
