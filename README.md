...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wb-opb_and_opb-wb_interface_wrapper
    Project category: system_on_chip
    Project branch: system_on_chip_wb-opb_and_opb-wb_interface_wrapper
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_wb-opb_and_opb-wb_interface_wrapper --single-branch https://github.com/fabriziotappero/ip-cores.git
