...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: alwcpu-a_light_weight_cpu
    Project category: processor
    Project branch: processor_alwcpu-a_light_weight_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_alwcpu-a_light_weight_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
