...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: jtag_test_access_port_tap
    Project category: other
    Project branch: other_jtag_test_access_port_tap
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_jtag_test_access_port_tap --single-branch https://github.com/fabriziotappero/ip-cores.git
