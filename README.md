...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: high_throughput_and_low_area_aes_core
    Project category: crypto_core
    Project branch: crypto_core_high_throughput_and_low_area_aes_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_high_throughput_and_low_area_aes_core --single-branch https://github.com/fabriziotappero/ip-cores.git
