...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: b-163_ec_arithmetic
    Project category: crypto_core
    Project branch: crypto_core_b-163_ec_arithmetic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_b-163_ec_arithmetic --single-branch https://github.com/fabriziotappero/ip-cores.git
