...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: functional_simulation_models_for_commercially_avai
    Project category: memory_core
    Project branch: memory_core_functional_simulation_models_for_commercially_avai
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_functional_simulation_models_for_commercially_avai --single-branch https://github.com/fabriziotappero/ip-cores.git
