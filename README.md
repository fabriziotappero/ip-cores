...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hypertransport_tunnel
    Project category: communication_controller
    Project branch: communication_controller_hypertransport_tunnel
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_hypertransport_tunnel --single-branch https://github.com/fabriziotappero/ip-cores.git
