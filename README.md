...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: game-trees_fpga_implementation_othello_game
    Project category: prototype_board
    Project branch: prototype_board_game-trees_fpga_implementation_othello_game
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_game-trees_fpga_implementation_othello_game --single-branch https://github.com/fabriziotappero/ip-cores.git
