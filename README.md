...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sp_ram_to_3p_ram_wishbone_wrapper
    Project category: memory_core
    Project branch: memory_core_sp_ram_to_3p_ram_wishbone_wrapper
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_sp_ram_to_3p_ram_wishbone_wrapper --single-branch https://github.com/fabriziotappero/ip-cores.git
