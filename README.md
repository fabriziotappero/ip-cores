...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opensparc-based_soc
    Project category: system_on_chip
    Project branch: system_on_chip_opensparc-based_soc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_opensparc-based_soc --single-branch https://github.com/fabriziotappero/ip-cores.git
