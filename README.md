...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: memory_mapped_lcd_controller_ks0073
    Project category: video_controller
    Project branch: video_controller_memory_mapped_lcd_controller_ks0073
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_memory_mapped_lcd_controller_ks0073 --single-branch https://github.com/fabriziotappero/ip-cores.git
