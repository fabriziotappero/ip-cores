...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: configurable_hamming_generator
    Project category: ecc_core
    Project branch: ecc_core_configurable_hamming_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_configurable_hamming_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
