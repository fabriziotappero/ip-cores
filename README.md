...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 16_bit_microcontroller
    Project category: processor
    Project branch: processor_16_bit_microcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_16_bit_microcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
