...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rs232_2
    Project category: communication_controller
    Project branch: communication_controller_rs232_2
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_rs232_2 --single-branch https://github.com/fabriziotappero/ip-cores.git
