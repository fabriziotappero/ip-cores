...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: xmatchpro_lossless_data_compressor
    Project category: other
    Project branch: other_xmatchpro_lossless_data_compressor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_xmatchpro_lossless_data_compressor --single-branch https://github.com/fabriziotappero/ip-cores.git
