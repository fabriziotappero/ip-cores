...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fixed_point_math_library_for_verilog
    Project category: arithmetic_core
    Project branch: arithmetic_core_fixed_point_math_library_for_verilog
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fixed_point_math_library_for_verilog --single-branch https://github.com/fabriziotappero/ip-cores.git
