...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: avalon_aes_ecb-core_128_192_256_bit
    Project category: crypto_core
    Project branch: crypto_core_avalon_aes_ecb-core_128_192_256_bit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_avalon_aes_ecb-core_128_192_256_bit --single-branch https://github.com/fabriziotappero/ip-cores.git
