...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: data_flow_processor
    Project category: processor
    Project branch: processor_data_flow_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_data_flow_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
