...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: prbs_signal_generator_and_checker
    Project category: testing-verification
    Project branch: testing-verification_prbs_signal_generator_and_checker
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_prbs_signal_generator_and_checker --single-branch https://github.com/fabriziotappero/ip-cores.git
