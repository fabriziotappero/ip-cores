...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tanh_approximation_custom_instruction_for_nios_ii
    Project category: arithmetic_core
    Project branch: arithmetic_core_tanh_approximation_custom_instruction_for_nios_ii
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_tanh_approximation_custom_instruction_for_nios_ii --single-branch https://github.com/fabriziotappero/ip-cores.git
