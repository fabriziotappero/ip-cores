...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: udp-ip_core
    Project category: communication_controller
    Project branch: communication_controller_udp-ip_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_udp-ip_core --single-branch https://github.com/fabriziotappero/ip-cores.git
