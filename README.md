...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fixed-point_quadratic_polynomial
    Project category: arithmetic_core
    Project branch: arithmetic_core_fixed-point_quadratic_polynomial
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fixed-point_quadratic_polynomial --single-branch https://github.com/fabriziotappero/ip-cores.git
