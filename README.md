...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ezidebug
    Project category: testing-verification
    Project branch: testing-verification_ezidebug
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_ezidebug --single-branch https://github.com/fabriziotappero/ip-cores.git
