...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: audio_dsp_pci_card
    Project category: prototype_board
    Project branch: prototype_board_audio_dsp_pci_card
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_audio_dsp_pci_card --single-branch https://github.com/fabriziotappero/ip-cores.git
