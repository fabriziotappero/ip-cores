...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: superscalar_version_of_dlx
    Project category: arithmetic_core
    Project branch: arithmetic_core_superscalar_version_of_dlx
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_superscalar_version_of_dlx --single-branch https://github.com/fabriziotappero/ip-cores.git
