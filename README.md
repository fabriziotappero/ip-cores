...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: single_port_asram
    Project category: memory_core
    Project branch: memory_core_single_port_asram
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_single_port_asram --single-branch https://github.com/fabriziotappero/ip-cores.git
