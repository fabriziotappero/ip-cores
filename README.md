...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: camellia_cores
    Project category: crypto_core
    Project branch: crypto_core_camellia_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_camellia_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
