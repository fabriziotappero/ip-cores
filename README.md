...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: galois_counter_mode_advanced_encryption_standard_g
    Project category: crypto_core
    Project branch: crypto_core_galois_counter_mode_advanced_encryption_standard_g
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_galois_counter_mode_advanced_encryption_standard_g --single-branch https://github.com/fabriziotappero/ip-cores.git
