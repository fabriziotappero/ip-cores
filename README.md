...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: video_pattern_generator
    Project category: testing-verification
    Project branch: testing-verification_video_pattern_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_video_pattern_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
