...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: complex_operations_ise_for_nios_ii
    Project category: arithmetic_core
    Project branch: arithmetic_core_complex_operations_ise_for_nios_ii
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_complex_operations_ise_for_nios_ii --single-branch https://github.com/fabriziotappero/ip-cores.git
