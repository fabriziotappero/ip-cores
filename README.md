...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ssp_slv
    Project category: communication_controller
    Project branch: communication_controller_ssp_slv
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ssp_slv --single-branch https://github.com/fabriziotappero/ip-cores.git
