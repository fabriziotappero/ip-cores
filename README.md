...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ipv4_ethernet_packet_creator_and_transmitter
    Project category: communication_controller
    Project branch: communication_controller_ipv4_ethernet_packet_creator_and_transmitter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ipv4_ethernet_packet_creator_and_transmitter --single-branch https://github.com/fabriziotappero/ip-cores.git
