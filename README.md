...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sweet32_cpu
    Project category: processor
    Project branch: processor_sweet32_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_sweet32_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
