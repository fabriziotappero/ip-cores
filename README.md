...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_galois_lfsr
    Project category: arithmetic_core
    Project branch: arithmetic_core_generic_galois_lfsr
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_generic_galois_lfsr --single-branch https://github.com/fabriziotappero/ip-cores.git
