...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nocnetwork-on-chip_simulator
    Project category: system_on_chip
    Project branch: system_on_chip_nocnetwork-on-chip_simulator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_nocnetwork-on-chip_simulator --single-branch https://github.com/fabriziotappero/ip-cores.git
