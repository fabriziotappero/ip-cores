...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bus_transaction_monitor_with_jtag
    Project category: testing-verification
    Project branch: testing-verification_bus_transaction_monitor_with_jtag
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_bus_transaction_monitor_with_jtag --single-branch https://github.com/fabriziotappero/ip-cores.git
