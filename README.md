...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bluespec_802.11a_transmitter
    Project category: communication_controller
    Project branch: communication_controller_bluespec_802.11a_transmitter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_bluespec_802.11a_transmitter --single-branch https://github.com/fabriziotappero/ip-cores.git
