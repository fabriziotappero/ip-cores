...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cpu6502_tc-r6502_processor_soft_core_with_accurate
    Project category: processor
    Project branch: processor_cpu6502_tc-r6502_processor_soft_core_with_accurate
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_cpu6502_tc-r6502_processor_soft_core_with_accurate --single-branch https://github.com/fabriziotappero/ip-cores.git
