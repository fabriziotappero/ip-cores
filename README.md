...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 2nd_order_sigma-delta_dac
    Project category: other
    Project branch: other_2nd_order_sigma-delta_dac
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_2nd_order_sigma-delta_dac --single-branch https://github.com/fabriziotappero/ip-cores.git
