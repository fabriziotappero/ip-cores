...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: plb-to-wb_bridge
    Project category: communication_controller
    Project branch: communication_controller_plb-to-wb_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_plb-to-wb_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
