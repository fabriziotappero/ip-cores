...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ethernet_switch_on_configurable_logic
    Project category: communication_controller
    Project branch: communication_controller_ethernet_switch_on_configurable_logic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ethernet_switch_on_configurable_logic --single-branch https://github.com/fabriziotappero/ip-cores.git
