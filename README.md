...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: general-purpose_i-o_gpio_core
    Project category: communication_controller
    Project branch: communication_controller_general-purpose_i-o_gpio_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_general-purpose_i-o_gpio_core --single-branch https://github.com/fabriziotappero/ip-cores.git
