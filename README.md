...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: uart_16550_core
    Project category: communication_controller
    Project branch: communication_controller_uart_16550_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_uart_16550_core --single-branch https://github.com/fabriziotappero/ip-cores.git
