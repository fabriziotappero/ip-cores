...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_lpc_host_and_peripheral_bridge
    Project category: communication_controller
    Project branch: communication_controller_wishbone_lpc_host_and_peripheral_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_wishbone_lpc_host_and_peripheral_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
