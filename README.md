...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: connect-6_solver
    Project category: other
    Project branch: other_connect-6_solver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_connect-6_solver --single-branch https://github.com/fabriziotappero/ip-cores.git
