...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sxp_simple_extensible_pipeline__processor
    Project category: processor
    Project branch: processor_sxp_simple_extensible_pipeline__processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_sxp_simple_extensible_pipeline__processor --single-branch https://github.com/fabriziotappero/ip-cores.git
