...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ps-2_keyboard_interface
    Project category: other
    Project branch: other_ps-2_keyboard_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_ps-2_keyboard_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
