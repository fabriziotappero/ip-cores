...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pid_controler
    Project category: arithmetic_core
    Project branch: arithmetic_core_pid_controler
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_pid_controler --single-branch https://github.com/fabriziotappero/ip-cores.git
