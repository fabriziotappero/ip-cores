...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ebu-spdif_to_i2s_project
    Project category: communication_controller
    Project branch: communication_controller_ebu-spdif_to_i2s_project
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ebu-spdif_to_i2s_project --single-branch https://github.com/fabriziotappero/ip-cores.git
