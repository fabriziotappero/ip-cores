...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_protocol_to_axi4_protocol
    Project category: arithmetic_core
    Project branch: arithmetic_core_wishbone_protocol_to_axi4_protocol
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_wishbone_protocol_to_axi4_protocol --single-branch https://github.com/fabriziotappero/ip-cores.git
