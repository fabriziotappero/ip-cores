...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_decryption_core_for_fpga
    Project category: crypto_core
    Project branch: crypto_core_aes_decryption_core_for_fpga
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_decryption_core_for_fpga --single-branch https://github.com/fabriziotappero/ip-cores.git
