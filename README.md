...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: microrisc_ii
    Project category: processor
    Project branch: processor_microrisc_ii
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_microrisc_ii --single-branch https://github.com/fabriziotappero/ip-cores.git
