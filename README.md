...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cavlc_decoder
    Project category: arithmetic_core
    Project branch: arithmetic_core_cavlc_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_cavlc_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
