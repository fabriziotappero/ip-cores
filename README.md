...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cpu_generator
    Project category: processor
    Project branch: processor_cpu_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_cpu_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
