...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: graphics_accelerator
    Project category: video_controller
    Project branch: video_controller_graphics_accelerator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_graphics_accelerator --single-branch https://github.com/fabriziotappero/ip-cores.git
