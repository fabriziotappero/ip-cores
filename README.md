...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: som-arm9-cycloneivgx
    Project category: system_on_module
    Project branch: system_on_module_som-arm9-cycloneivgx
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_module_som-arm9-cycloneivgx --single-branch https://github.com/fabriziotappero/ip-cores.git
