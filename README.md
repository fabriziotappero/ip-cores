...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mips32_release_1
    Project category: processor
    Project branch: processor_mips32_release_1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mips32_release_1 --single-branch https://github.com/fabriziotappero/ip-cores.git
