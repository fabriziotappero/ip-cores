...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: viterbi_hdl_code_generator
    Project category: arithmetic_core
    Project branch: arithmetic_core_viterbi_hdl_code_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_viterbi_hdl_code_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
