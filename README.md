...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: advanced_debug_system
    Project category: other
    Project branch: other_advanced_debug_system
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_advanced_debug_system --single-branch https://github.com/fabriziotappero/ip-cores.git
