...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: uart16750
    Project category: communication_controller
    Project branch: communication_controller_uart16750
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_uart16750 --single-branch https://github.com/fabriziotappero/ip-cores.git
