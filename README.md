...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: synchronous_reset_fifo_with_testbench
    Project category: memory_core
    Project branch: memory_core_synchronous_reset_fifo_with_testbench
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_synchronous_reset_fifo_with_testbench --single-branch https://github.com/fabriziotappero/ip-cores.git
