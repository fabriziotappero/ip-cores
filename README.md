...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lzrw1_compressor_core
    Project category: arithmetic_core
    Project branch: arithmetic_core_lzrw1_compressor_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_lzrw1_compressor_core --single-branch https://github.com/fabriziotappero/ip-cores.git
