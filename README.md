...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtfspritecontroller-hardware_cursors
    Project category: video_controller
    Project branch: video_controller_rtfspritecontroller-hardware_cursors
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_rtfspritecontroller-hardware_cursors --single-branch https://github.com/fabriziotappero/ip-cores.git
