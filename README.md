...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ami-hdb1_line_codes
    Project category: communication_controller
    Project branch: communication_controller_ami-hdb1_line_codes
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ami-hdb1_line_codes --single-branch https://github.com/fabriziotappero/ip-cores.git
