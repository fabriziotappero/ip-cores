...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: zpu-the_worlds_smallest_32_bit_cpu_with_gcc_toolch
    Project category: processor
    Project branch: processor_zpu-the_worlds_smallest_32_bit_cpu_with_gcc_toolch
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_zpu-the_worlds_smallest_32_bit_cpu_with_gcc_toolch --single-branch https://github.com/fabriziotappero/ip-cores.git
