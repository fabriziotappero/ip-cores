...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: single_clock_unsigned_division_algorithm
    Project category: arithmetic_core
    Project branch: arithmetic_core_single_clock_unsigned_division_algorithm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_single_clock_unsigned_division_algorithm --single-branch https://github.com/fabriziotappero/ip-cores.git
