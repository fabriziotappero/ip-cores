...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: constrained_random_test_generator
    Project category: testing-verification
    Project branch: testing-verification_constrained_random_test_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_constrained_random_test_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
