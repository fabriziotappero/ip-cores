...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openrisc_2000
    Project category: processor
    Project branch: processor_openrisc_2000
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_openrisc_2000 --single-branch https://github.com/fabriziotappero/ip-cores.git
