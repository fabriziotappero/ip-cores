...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 8-bit_microcontroller_with_extended_peripheral_set
    Project category: processor
    Project branch: processor_8-bit_microcontroller_with_extended_peripheral_set
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_8-bit_microcontroller_with_extended_peripheral_set --single-branch https://github.com/fabriziotappero/ip-cores.git
