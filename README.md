...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: reed_solomon_decoder_204188
    Project category: ecc_core
    Project branch: ecc_core_reed_solomon_decoder_204188
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_reed_solomon_decoder_204188 --single-branch https://github.com/fabriziotappero/ip-cores.git
