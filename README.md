...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: edge_processor_mips
    Project category: processor
    Project branch: processor_edge_processor_mips
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_edge_processor_mips --single-branch https://github.com/fabriziotappero/ip-cores.git
