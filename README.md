...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nand_controller_onfi_compliant
    Project category: memory_core
    Project branch: memory_core_nand_controller_onfi_compliant
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_nand_controller_onfi_compliant --single-branch https://github.com/fabriziotappero/ip-cores.git
