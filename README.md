...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: leros_a_tiny_microcontroller_for_fpgas
    Project category: processor
    Project branch: processor_leros_a_tiny_microcontroller_for_fpgas
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_leros_a_tiny_microcontroller_for_fpgas --single-branch https://github.com/fabriziotappero/ip-cores.git
