...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: logarithm_function_base-2_single-cycle
    Project category: arithmetic_core
    Project branch: arithmetic_core_logarithm_function_base-2_single-cycle
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_logarithm_function_base-2_single-cycle --single-branch https://github.com/fabriziotappero/ip-cores.git
