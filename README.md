...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: yet_another_vga
    Project category: video_controller
    Project branch: video_controller_yet_another_vga
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_yet_another_vga --single-branch https://github.com/fabriziotappero/ip-cores.git
