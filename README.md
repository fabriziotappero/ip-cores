...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: de1_olpcl2294_system
    Project category: prototype_board
    Project branch: prototype_board_de1_olpcl2294_system
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_de1_olpcl2294_system --single-branch https://github.com/fabriziotappero/ip-cores.git
