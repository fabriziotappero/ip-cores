...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hasm_testbench_vector_generator
    Project category: testing-verification
    Project branch: testing-verification_hasm_testbench_vector_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_hasm_testbench_vector_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
