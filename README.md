...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: amber_arm-compatible_core
    Project category: processor
    Project branch: processor_amber_arm-compatible_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_amber_arm-compatible_core --single-branch https://github.com/fabriziotappero/ip-cores.git
