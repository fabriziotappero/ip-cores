...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: maximum-minimum_binary_tree_finder
    Project category: arithmetic_core
    Project branch: arithmetic_core_maximum-minimum_binary_tree_finder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_maximum-minimum_binary_tree_finder --single-branch https://github.com/fabriziotappero/ip-cores.git
