...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: staplplayer
    Project category: testing-verification
    Project branch: testing-verification_staplplayer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_staplplayer --single-branch https://github.com/fabriziotappero/ip-cores.git
