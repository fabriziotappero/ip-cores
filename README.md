...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fpga-based_median_filter
    Project category: arithmetic_core
    Project branch: arithmetic_core_fpga-based_median_filter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_fpga-based_median_filter --single-branch https://github.com/fabriziotappero/ip-cores.git
