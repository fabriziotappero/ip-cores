...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cheap_ethernet_interface
    Project category: communication_controller
    Project branch: communication_controller_cheap_ethernet_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_cheap_ethernet_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
