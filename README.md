...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: double_error_correcting_dec_bch_encoder-decoder
    Project category: ecc_core
    Project branch: ecc_core_double_error_correcting_dec_bch_encoder-decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_double_error_correcting_dec_bch_encoder-decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
