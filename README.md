...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openrisc_1200_graphic_configuration_tool
    Project category: other
    Project branch: other_openrisc_1200_graphic_configuration_tool
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_openrisc_1200_graphic_configuration_tool --single-branch https://github.com/fabriziotappero/ip-cores.git
