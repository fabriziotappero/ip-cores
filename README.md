...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opb-compatible_vga_character_display_no_dac
    Project category: video_controller
    Project branch: video_controller_opb-compatible_vga_character_display_no_dac
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_opb-compatible_vga_character_display_no_dac --single-branch https://github.com/fabriziotappero/ip-cores.git
