...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_out_port_from_b3_spec
    Project category: system_on_chip
    Project branch: system_on_chip_wishbone_out_port_from_b3_spec
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_wishbone_out_port_from_b3_spec --single-branch https://github.com/fabriziotappero/ip-cores.git
