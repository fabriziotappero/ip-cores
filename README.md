...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pipelined_aes
    Project category: crypto_core
    Project branch: crypto_core_pipelined_aes
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_pipelined_aes --single-branch https://github.com/fabriziotappero/ip-cores.git
