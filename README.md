...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: risc_core_i
    Project category: processor
    Project branch: processor_risc_core_i
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_risc_core_i --single-branch https://github.com/fabriziotappero/ip-cores.git
