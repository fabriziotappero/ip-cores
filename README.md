...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb-fpga_module_1.15
    Project category: prototype_board
    Project branch: prototype_board_usb-fpga_module_1.15
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_usb-fpga_module_1.15 --single-branch https://github.com/fabriziotappero/ip-cores.git
