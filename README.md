...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_to_use_sha-2_algorithm
    Project category: crypto_core
    Project branch: crypto_core_simple_to_use_sha-2_algorithm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_simple_to_use_sha-2_algorithm --single-branch https://github.com/fabriziotappero/ip-cores.git
