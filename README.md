...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_dma-bridge_ip_core
    Project category: system_on_chip
    Project branch: system_on_chip_wishbone_dma-bridge_ip_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_wishbone_dma-bridge_ip_core --single-branch https://github.com/fabriziotappero/ip-cores.git
