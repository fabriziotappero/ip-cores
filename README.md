...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nios_ii_custom_instructions
    Project category: other
    Project branch: other_nios_ii_custom_instructions
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_nios_ii_custom_instructions --single-branch https://github.com/fabriziotappero/ip-cores.git
