...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_mini
    Project category: system_controller
    Project branch: system_controller_pci_mini
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_pci_mini --single-branch https://github.com/fabriziotappero/ip-cores.git
