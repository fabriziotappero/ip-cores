...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: compact_aes-ccm_core
    Project category: crypto_core
    Project branch: crypto_core_compact_aes-ccm_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_compact_aes-ccm_core --single-branch https://github.com/fabriziotappero/ip-cores.git
