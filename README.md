...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bubblesortmodule
    Project category: other
    Project branch: other_bubblesortmodule
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_bubblesortmodule --single-branch https://github.com/fabriziotappero/ip-cores.git
