...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_uart_controller_8_bit
    Project category: communication_controller
    Project branch: communication_controller_wishbone_uart_controller_8_bit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_wishbone_uart_controller_8_bit --single-branch https://github.com/fabriziotappero/ip-cores.git
