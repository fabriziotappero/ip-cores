...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: y80e-z80-z180_compatible_processor_extended_by_ez8
    Project category: processor
    Project branch: processor_y80e-z80-z180_compatible_processor_extended_by_ez8
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_y80e-z80-z180_compatible_processor_extended_by_ez8 --single-branch https://github.com/fabriziotappero/ip-cores.git
