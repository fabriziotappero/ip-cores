...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cf_interleaver
    Project category: memory_core
    Project branch: memory_core_cf_interleaver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_cf_interleaver --single-branch https://github.com/fabriziotappero/ip-cores.git
