...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_fifos
    Project category: memory_core
    Project branch: memory_core_generic_fifos
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_generic_fifos --single-branch https://github.com/fabriziotappero/ip-cores.git
