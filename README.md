...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nco-periodic_waveform_generator
    Project category: dsp_core
    Project branch: dsp_core_nco-periodic_waveform_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_nco-periodic_waveform_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
