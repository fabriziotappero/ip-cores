...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hardware_implementation_of_binary_fully_digital_ph
    Project category: arithmetic_core
    Project branch: arithmetic_core_hardware_implementation_of_binary_fully_digital_ph
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_hardware_implementation_of_binary_fully_digital_ph --single-branch https://github.com/fabriziotappero/ip-cores.git
