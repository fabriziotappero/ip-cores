...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: experimental_unstable_cpu
    Project category: system_on_chip
    Project branch: system_on_chip_experimental_unstable_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_experimental_unstable_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
