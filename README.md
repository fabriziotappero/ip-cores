...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: smartcard_interface_iso7816-3
    Project category: communication_controller
    Project branch: communication_controller_smartcard_interface_iso7816-3
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_smartcard_interface_iso7816-3 --single-branch https://github.com/fabriziotappero/ip-cores.git
