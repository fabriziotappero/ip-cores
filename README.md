...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: radix_4_complex_fft
    Project category: arithmetic_core
    Project branch: arithmetic_core_radix_4_complex_fft
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_radix_4_complex_fft --single-branch https://github.com/fabriziotappero/ip-cores.git
