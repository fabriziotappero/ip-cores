...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: population_counter_generator
    Project category: arithmetic_core
    Project branch: arithmetic_core_population_counter_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_population_counter_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
