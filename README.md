...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: internal_logic_state_analyzer
    Project category: prototype_board
    Project branch: prototype_board_internal_logic_state_analyzer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_internal_logic_state_analyzer --single-branch https://github.com/fabriziotappero/ip-cores.git
