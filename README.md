...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: firgen-multgen
    Project category: dsp_core
    Project branch: dsp_core_firgen-multgen
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_firgen-multgen --single-branch https://github.com/fabriziotappero/ip-cores.git
