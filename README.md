...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ccitt-g4tiff_compression
    Project category: video_controller
    Project branch: video_controller_ccitt-g4tiff_compression
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_ccitt-g4tiff_compression --single-branch https://github.com/fabriziotappero/ip-cores.git
