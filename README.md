...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: directmappedcachecontroller
    Project category: memory_core
    Project branch: memory_core_directmappedcachecontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_directmappedcachecontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
