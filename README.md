...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opencores54x_dsp
    Project category: processor
    Project branch: processor_opencores54x_dsp
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_opencores54x_dsp --single-branch https://github.com/fabriziotappero/ip-cores.git
