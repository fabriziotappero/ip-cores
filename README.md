...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ultimate_crc
    Project category: ecc_core
    Project branch: ecc_core_ultimate_crc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_ultimate_crc --single-branch https://github.com/fabriziotappero/ip-cores.git
