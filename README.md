...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: e1-g.703g.704g.706_framer-deframer
    Project category: communication_controller
    Project branch: communication_controller_e1-g.703g.704g.706_framer-deframer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_e1-g.703g.704g.706_framer-deframer --single-branch https://github.com/fabriziotappero/ip-cores.git
