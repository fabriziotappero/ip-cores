...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mmu_for_z80_and_ez80
    Project category: processor
    Project branch: processor_mmu_for_z80_and_ez80
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mmu_for_z80_and_ez80 --single-branch https://github.com/fabriziotappero/ip-cores.git
