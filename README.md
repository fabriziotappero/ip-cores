...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: theia_ray_graphic_processing_unit
    Project category: processor
    Project branch: processor_theia_ray_graphic_processing_unit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_theia_ray_graphic_processing_unit --single-branch https://github.com/fabriziotappero/ip-cores.git
