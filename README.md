...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: viterbi_tx_rx
    Project category: arithmetic_core
    Project branch: arithmetic_core_viterbi_tx_rx
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_viterbi_tx_rx --single-branch https://github.com/fabriziotappero/ip-cores.git
