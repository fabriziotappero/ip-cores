...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: high_latency_bursting_wishbone_wrapper_for_xilinx_
    Project category: memory_core
    Project branch: memory_core_high_latency_bursting_wishbone_wrapper_for_xilinx_
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_high_latency_bursting_wishbone_wrapper_for_xilinx_ --single-branch https://github.com/fabriziotappero/ip-cores.git
