...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: omrp_prototype_board_v2
    Project category: prototype_board
    Project branch: prototype_board_omrp_prototype_board_v2
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_omrp_prototype_board_v2 --single-branch https://github.com/fabriziotappero/ip-cores.git
