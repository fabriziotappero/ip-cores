...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cdc_micro_fifo
    Project category: other
    Project branch: other_cdc_micro_fifo
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_cdc_micro_fifo --single-branch https://github.com/fabriziotappero/ip-cores.git
