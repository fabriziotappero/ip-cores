...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemc-verilog_md5
    Project category: crypto_core
    Project branch: crypto_core_systemc-verilog_md5
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_systemc-verilog_md5 --single-branch https://github.com/fabriziotappero/ip-cores.git
