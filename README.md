...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: clairisc-runs_12bit_opcode_pic_family.
    Project category: processor
    Project branch: processor_clairisc-runs_12bit_opcode_pic_family.
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_clairisc-runs_12bit_opcode_pic_family. --single-branch https://github.com/fabriziotappero/ip-cores.git
