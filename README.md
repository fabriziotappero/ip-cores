...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb_2.0_function_core
    Project category: communication_controller
    Project branch: communication_controller_usb_2.0_function_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_usb_2.0_function_core --single-branch https://github.com/fabriziotappero/ip-cores.git
