...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bluespec_cryptosorter
    Project category: crypto_core
    Project branch: crypto_core_bluespec_cryptosorter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_bluespec_cryptosorter --single-branch https://github.com/fabriziotappero/ip-cores.git
