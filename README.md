...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_traffic_light_controller_for_modelmaking_pu
    Project category: other
    Project branch: other_simple_traffic_light_controller_for_modelmaking_pu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_simple_traffic_light_controller_for_modelmaking_pu --single-branch https://github.com/fabriziotappero/ip-cores.git
