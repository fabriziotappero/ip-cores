...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sardmips
    Project category: system_on_chip
    Project branch: system_on_chip_sardmips
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_sardmips --single-branch https://github.com/fabriziotappero/ip-cores.git
