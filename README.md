...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: polyphase_decimation_filter
    Project category: dsp_core
    Project branch: dsp_core_polyphase_decimation_filter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_polyphase_decimation_filter --single-branch https://github.com/fabriziotappero/ip-cores.git
