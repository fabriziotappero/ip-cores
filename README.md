...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_camellia_crypto_core
    Project category: crypto_core
    Project branch: crypto_core_simple_camellia_crypto_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_simple_camellia_crypto_core --single-branch https://github.com/fabriziotappero/ip-cores.git
