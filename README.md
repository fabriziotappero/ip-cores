...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: modular_oscilloscope
    Project category: other
    Project branch: other_modular_oscilloscope
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_modular_oscilloscope --single-branch https://github.com/fabriziotappero/ip-cores.git
