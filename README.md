...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ima_adpcm_encdoer_and_decoder
    Project category: dsp_core
    Project branch: dsp_core_ima_adpcm_encdoer_and_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_ima_adpcm_encdoer_and_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
