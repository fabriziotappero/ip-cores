...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: the_wizardry_project
    Project category: other
    Project branch: other_the_wizardry_project
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_the_wizardry_project --single-branch https://github.com/fabriziotappero/ip-cores.git
