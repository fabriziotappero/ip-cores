...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spread_spectrum_modulator_and_demodulator_using_bp
    Project category: ecc_core
    Project branch: ecc_core_spread_spectrum_modulator_and_demodulator_using_bp
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_spread_spectrum_modulator_and_demodulator_using_bp --single-branch https://github.com/fabriziotappero/ip-cores.git
