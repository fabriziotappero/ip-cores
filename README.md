...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dwt_coprocessor_on_still_image
    Project category: other
    Project branch: other_dwt_coprocessor_on_still_image
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_dwt_coprocessor_on_still_image --single-branch https://github.com/fabriziotappero/ip-cores.git
