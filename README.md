...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pal-ntsc_encoder
    Project category: video_controller
    Project branch: video_controller_pal-ntsc_encoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_pal-ntsc_encoder --single-branch https://github.com/fabriziotappero/ip-cores.git
