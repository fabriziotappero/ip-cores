...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: tosnet_framework
    Project category: other
    Project branch: other_tosnet_framework
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_tosnet_framework --single-branch https://github.com/fabriziotappero/ip-cores.git
