...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: scalable_arbiter
    Project category: other
    Project branch: other_scalable_arbiter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_scalable_arbiter --single-branch https://github.com/fabriziotappero/ip-cores.git
