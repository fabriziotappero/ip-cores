...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: software_aided_wishbone_extension_for_xilinx_r_p
    Project category: processor
    Project branch: processor_software_aided_wishbone_extension_for_xilinx_r_p
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_software_aided_wishbone_extension_for_xilinx_r_p --single-branch https://github.com/fabriziotappero/ip-cores.git
