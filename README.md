...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: small_1-wire_onewire_master_with_altera_tools_in
    Project category: communication_controller
    Project branch: communication_controller_small_1-wire_onewire_master_with_altera_tools_in
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_small_1-wire_onewire_master_with_altera_tools_in --single-branch https://github.com/fabriziotappero/ip-cores.git
