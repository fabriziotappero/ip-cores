...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: t400_Âµcontroller
    Project category: processor
    Project branch: processor_t400_Âµcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_t400_Âµcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
