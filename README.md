...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: three_compact_implementations_of_aes_encryption
    Project category: crypto_core
    Project branch: crypto_core_three_compact_implementations_of_aes_encryption
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_three_compact_implementations_of_aes_encryption --single-branch https://github.com/fabriziotappero/ip-cores.git
