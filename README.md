...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: z80-based_vector_graphic_single-board_computer
    Project category: other
    Project branch: other_z80-based_vector_graphic_single-board_computer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_z80-based_vector_graphic_single-board_computer --single-branch https://github.com/fabriziotappero/ip-cores.git
