...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hardware_looping_unit
    Project category: other
    Project branch: other_hardware_looping_unit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_hardware_looping_unit --single-branch https://github.com/fabriziotappero/ip-cores.git
