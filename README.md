...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbonetk_toolkit
    Project category: system_on_chip
    Project branch: system_on_chip_wishbonetk_toolkit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_wishbonetk_toolkit --single-branch https://github.com/fabriziotappero/ip-cores.git
