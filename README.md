...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtfbitmapcontroller
    Project category: video_controller
    Project branch: video_controller_rtfbitmapcontroller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_rtfbitmapcontroller --single-branch https://github.com/fabriziotappero/ip-cores.git
