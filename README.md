...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: vhdl_16550_uart_core
    Project category: communication_controller
    Project branch: communication_controller_vhdl_16550_uart_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_vhdl_16550_uart_core --single-branch https://github.com/fabriziotappero/ip-cores.git
