...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_express_16_bit_crc_verilog_file
    Project category: ecc_core
    Project branch: ecc_core_pci_express_16_bit_crc_verilog_file
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_pci_express_16_bit_crc_verilog_file --single-branch https://github.com/fabriziotappero/ip-cores.git
