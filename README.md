...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: riscompatible
    Project category: processor
    Project branch: processor_riscompatible
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_riscompatible --single-branch https://github.com/fabriziotappero/ip-cores.git
