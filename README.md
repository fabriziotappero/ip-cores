...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: next_80186_processor
    Project category: processor
    Project branch: processor_next_80186_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_next_80186_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
