...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project branch: communication_controller_i2cgpio
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_i2cgpio --single-branch https://github.com/fabriziotappero/ip-cores.git
