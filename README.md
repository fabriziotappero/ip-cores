...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rc4_pseudo-random_stream_generator
    Project category: crypto_core
    Project branch: crypto_core_rc4_pseudo-random_stream_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_rc4_pseudo-random_stream_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
