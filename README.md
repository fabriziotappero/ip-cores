...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: altor32-alternative_lightweight_openrisc_cpu
    Project category: processor
    Project branch: processor_altor32-alternative_lightweight_openrisc_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_altor32-alternative_lightweight_openrisc_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
