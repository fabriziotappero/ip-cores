...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: noc_based_mpsoc
    Project category: system_on_chip
    Project branch: system_on_chip_noc_based_mpsoc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_noc_based_mpsoc --single-branch https://github.com/fabriziotappero/ip-cores.git
