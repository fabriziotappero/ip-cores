...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ham_7_4_enc
    Project category: ecc_core
    Project branch: ecc_core_ham_7_4_enc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_ham_7_4_enc --single-branch https://github.com/fabriziotappero/ip-cores.git
