...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bluespec_md6
    Project category: crypto_core
    Project branch: crypto_core_bluespec_md6
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_bluespec_md6 --single-branch https://github.com/fabriziotappero/ip-cores.git
