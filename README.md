...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_bridge
    Project category: system_controller
    Project branch: system_controller_pci_bridge
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_pci_bridge --single-branch https://github.com/fabriziotappero/ip-cores.git
