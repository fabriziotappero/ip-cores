...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_systemverilog_behavioral_model
    Project category: crypto_core
    Project branch: crypto_core_aes_systemverilog_behavioral_model
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_systemverilog_behavioral_model --single-branch https://github.com/fabriziotappero/ip-cores.git
