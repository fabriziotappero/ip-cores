...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: axi_dma_32-64_bits
    Project category: system_on_chip
    Project branch: system_on_chip_axi_dma_32-64_bits
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_axi_dma_32-64_bits --single-branch https://github.com/fabriziotappero/ip-cores.git
