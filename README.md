...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: binary_to_bcd_conversions_with_led_display_driver
    Project category: arithmetic_core
    Project branch: arithmetic_core_binary_to_bcd_conversions_with_led_display_driver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_binary_to_bcd_conversions_with_led_display_driver --single-branch https://github.com/fabriziotappero/ip-cores.git
