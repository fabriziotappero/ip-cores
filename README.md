...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: xilinx_virtex_floating_point
    Project category: arithmetic_core
    Project branch: arithmetic_core_xilinx_virtex_floating_point
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_xilinx_virtex_floating_point --single-branch https://github.com/fabriziotappero/ip-cores.git
