...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: serial_uart_1
    Project category: communication_controller
    Project branch: communication_controller_serial_uart_1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_serial_uart_1 --single-branch https://github.com/fabriziotappero/ip-cores.git
