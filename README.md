...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: manchester_to_uart_converter
    Project category: communication_controller
    Project branch: communication_controller_manchester_to_uart_converter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_manchester_to_uart_converter --single-branch https://github.com/fabriziotappero/ip-cores.git
