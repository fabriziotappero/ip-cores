...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: axi4_transactor_and_bus_functional_model
    Project category: system_on_chip
    Project branch: system_on_chip_axi4_transactor_and_bus_functional_model
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_axi4_transactor_and_bus_functional_model --single-branch https://github.com/fabriziotappero/ip-cores.git
