...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: interrupt_controller_68k
    Project category: other
    Project branch: other_interrupt_controller_68k
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_interrupt_controller_68k --single-branch https://github.com/fabriziotappero/ip-cores.git
