...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mips-faulttolerant
    Project category: processor
    Project branch: processor_mips-faulttolerant
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_mips-faulttolerant --single-branch https://github.com/fabriziotappero/ip-cores.git
