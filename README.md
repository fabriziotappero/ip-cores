...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: microprocessor_za208
    Project category: arithmetic_core
    Project branch: arithmetic_core_microprocessor_za208
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_microprocessor_za208 --single-branch https://github.com/fabriziotappero/ip-cores.git
