...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: storm_soc
    Project category: system_on_chip
    Project branch: system_on_chip_storm_soc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_storm_soc --single-branch https://github.com/fabriziotappero/ip-cores.git
