...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: complex_gaussian_pseudo-random_number_generator
    Project category: arithmetic_core
    Project branch: arithmetic_core_complex_gaussian_pseudo-random_number_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_complex_gaussian_pseudo-random_number_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
