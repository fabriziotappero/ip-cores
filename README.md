...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: storm_core_arm7_compatible
    Project category: processor
    Project branch: processor_storm_core_arm7_compatible
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_storm_core_arm7_compatible --single-branch https://github.com/fabriziotappero/ip-cores.git
