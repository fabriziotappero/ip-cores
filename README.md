...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: open8_urisc
    Project category: processor
    Project branch: processor_open8_urisc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_open8_urisc --single-branch https://github.com/fabriziotappero/ip-cores.git
