...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_cores_compact
    Project category: crypto_core
    Project branch: crypto_core_aes_cores_compact
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_cores_compact --single-branch https://github.com/fabriziotappero/ip-cores.git
