...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: brainfuck_cpu
    Project category: processor
    Project branch: processor_brainfuck_cpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_brainfuck_cpu --single-branch https://github.com/fabriziotappero/ip-cores.git
