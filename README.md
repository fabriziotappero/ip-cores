...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: uart_fifo_cpu_interface_with_sv_self-checking_te
    Project category: communication_controller
    Project branch: communication_controller_uart_fifo_cpu_interface_with_sv_self-checking_te
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_uart_fifo_cpu_interface_with_sv_self-checking_te --single-branch https://github.com/fabriziotappero/ip-cores.git
