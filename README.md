...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: codezero_openrisc_port
    Project category: processor
    Project branch: processor_codezero_openrisc_port
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_codezero_openrisc_port --single-branch https://github.com/fabriziotappero/ip-cores.git
