...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: parametrized_fft_engine
    Project category: arithmetic_core
    Project branch: arithmetic_core_parametrized_fft_engine
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_parametrized_fft_engine --single-branch https://github.com/fabriziotappero/ip-cores.git
