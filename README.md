...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bluespec_h.264_decoder
    Project category: video_controller
    Project branch: video_controller_bluespec_h.264_decoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_bluespec_h.264_decoder --single-branch https://github.com/fabriziotappero/ip-cores.git
