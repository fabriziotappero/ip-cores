...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ddr_sdram_controller_core
    Project category: memory_core
    Project branch: memory_core_ddr_sdram_controller_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_ddr_sdram_controller_core --single-branch https://github.com/fabriziotappero/ip-cores.git
