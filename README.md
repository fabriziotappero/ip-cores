...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: g-fir_tf-df
    Project category: dsp_core
    Project branch: dsp_core_g-fir_tf-df
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_g-fir_tf-df --single-branch https://github.com/fabriziotappero/ip-cores.git
