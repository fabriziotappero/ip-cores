...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: versatile_counter
    Project category: arithmetic_core
    Project branch: arithmetic_core_versatile_counter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_versatile_counter --single-branch https://github.com/fabriziotappero/ip-cores.git
