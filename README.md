...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: reed-solomon_decoder-encoder
    Project category: ecc_core
    Project branch: ecc_core_reed-solomon_decoder-encoder
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_reed-solomon_decoder-encoder --single-branch https://github.com/fabriziotappero/ip-cores.git
