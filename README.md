...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: high_performance_dynamic_memory_controller
    Project category: memory_core
    Project branch: memory_core_high_performance_dynamic_memory_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_high_performance_dynamic_memory_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
