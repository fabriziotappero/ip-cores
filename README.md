...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lightweight_8080_compatible_core
    Project category: processor
    Project branch: processor_lightweight_8080_compatible_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_lightweight_8080_compatible_core --single-branch https://github.com/fabriziotappero/ip-cores.git
