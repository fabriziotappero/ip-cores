...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spi_verilog_master_and_slave_modules
    Project category: communication_controller
    Project branch: communication_controller_spi_verilog_master_and_slave_modules
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spi_verilog_master_and_slave_modules --single-branch https://github.com/fabriziotappero/ip-cores.git
