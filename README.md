...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: trigonometric_functions_degrees_in_double_fpu
    Project category: arithmetic_core
    Project branch: arithmetic_core_trigonometric_functions_degrees_in_double_fpu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_trigonometric_functions_degrees_in_double_fpu --single-branch https://github.com/fabriziotappero/ip-cores.git
