...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: power_supply_sequencer
    Project category: system_controller
    Project branch: system_controller_power_supply_sequencer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_power_supply_sequencer --single-branch https://github.com/fabriziotappero/ip-cores.git
