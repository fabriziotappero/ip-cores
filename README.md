...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: xilinx_configuration_port_icape2_via_wishbone
    Project category: other
    Project branch: other_xilinx_configuration_port_icape2_via_wishbone
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_xilinx_configuration_port_icape2_via_wishbone --single-branch https://github.com/fabriziotappero/ip-cores.git
