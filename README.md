...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ft2232h_usb_avalon_core
    Project category: communication_controller
    Project branch: communication_controller_ft2232h_usb_avalon_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ft2232h_usb_avalon_core --single-branch https://github.com/fabriziotappero/ip-cores.git
