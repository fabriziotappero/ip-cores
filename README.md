...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dqpsk_symbol_mapper
    Project category: communication_controller
    Project branch: communication_controller_dqpsk_symbol_mapper
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_dqpsk_symbol_mapper --single-branch https://github.com/fabriziotappero/ip-cores.git
