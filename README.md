...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: quadrature_decoder-counter
    Project category: communication_controller
    Project branch: communication_controller_quadrature_decoder-counter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_quadrature_decoder-counter --single-branch https://github.com/fabriziotappero/ip-cores.git
