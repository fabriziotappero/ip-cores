...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: single_slot_pcm_interface
    Project category: communication_controller
    Project branch: communication_controller_single_slot_pcm_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_single_slot_pcm_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
