...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 16-bit_open_urisc_core_processor
    Project category: processor
    Project branch: processor_16-bit_open_urisc_core_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_16-bit_open_urisc_core_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
