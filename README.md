...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: crypto-pan
    Project category: crypto_core
    Project branch: crypto_core_crypto-pan
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_crypto-pan --single-branch https://github.com/fabriziotappero/ip-cores.git
