...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rsa_processor
    Project category: crypto_core
    Project branch: crypto_core_rsa_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_rsa_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
