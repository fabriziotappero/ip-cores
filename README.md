...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rfid_tag_and_reader
    Project category: system_on_chip
    Project branch: system_on_chip_rfid_tag_and_reader
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_rfid_tag_and_reader --single-branch https://github.com/fabriziotappero/ip-cores.git
