...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: apollo_guidance_computer_nor_emulator
    Project category: processor
    Project branch: processor_apollo_guidance_computer_nor_emulator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_apollo_guidance_computer_nor_emulator --single-branch https://github.com/fabriziotappero/ip-cores.git
