...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: montgomery_modular_multiplier_and_exponentiator
    Project category: crypto_core
    Project branch: crypto_core_montgomery_modular_multiplier_and_exponentiator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_montgomery_modular_multiplier_and_exponentiator --single-branch https://github.com/fabriziotappero/ip-cores.git
