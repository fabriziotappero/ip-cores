...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: gnextrapolator
    Project category: arithmetic_core
    Project branch: arithmetic_core_gnextrapolator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_gnextrapolator --single-branch https://github.com/fabriziotappero/ip-cores.git
