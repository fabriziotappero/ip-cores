...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: quadrature_oscillator
    Project category: dsp_core
    Project branch: dsp_core_quadrature_oscillator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_quadrature_oscillator --single-branch https://github.com/fabriziotappero/ip-cores.git
