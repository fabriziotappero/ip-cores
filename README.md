...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: from_and_to_files
    Project category: testing-verification
    Project branch: testing-verification_from_and_to_files
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_from_and_to_files --single-branch https://github.com/fabriziotappero/ip-cores.git
