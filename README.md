...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openverifla-fpga_logic_analyzer
    Project category: library
    Project branch: library_openverifla-fpga_logic_analyzer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b library_openverifla-fpga_logic_analyzer --single-branch https://github.com/fabriziotappero/ip-cores.git
