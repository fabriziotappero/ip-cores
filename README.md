...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ep2c35_board
    Project category: prototype_board
    Project branch: prototype_board_ep2c35_board
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_ep2c35_board --single-branch https://github.com/fabriziotappero/ip-cores.git
