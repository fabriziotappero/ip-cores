...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 1664_microprocessor
    Project category: processor
    Project branch: processor_1664_microprocessor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_1664_microprocessor --single-branch https://github.com/fabriziotappero/ip-cores.git
