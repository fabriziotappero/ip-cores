...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: keypad_scanner
    Project category: other
    Project branch: other_keypad_scanner
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_keypad_scanner --single-branch https://github.com/fabriziotappero/ip-cores.git
