...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ethernet_10ge_mac
    Project category: communication_controller
    Project branch: communication_controller_ethernet_10ge_mac
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_ethernet_10ge_mac --single-branch https://github.com/fabriziotappero/ip-cores.git
