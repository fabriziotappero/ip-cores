...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: programmable_interrupt_controller
    Project category: system_controller
    Project branch: system_controller_programmable_interrupt_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_programmable_interrupt_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
