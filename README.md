...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ecpu_alu
    Project category: arithmetic_core
    Project branch: arithmetic_core_ecpu_alu
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_ecpu_alu --single-branch https://github.com/fabriziotappero/ip-cores.git
