...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pyramid_integer_multiplier_unit
    Project category: arithmetic_core
    Project branch: arithmetic_core_pyramid_integer_multiplier_unit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_pyramid_integer_multiplier_unit --single-branch https://github.com/fabriziotappero/ip-cores.git
