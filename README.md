...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: all-pole_iir_filters
    Project category: dsp_core
    Project branch: dsp_core_all-pole_iir_filters
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_all-pole_iir_filters --single-branch https://github.com/fabriziotappero/ip-cores.git
