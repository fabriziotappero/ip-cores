...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pdp-8_processor_core_and_system
    Project category: processor
    Project branch: processor_pdp-8_processor_core_and_system
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_pdp-8_processor_core_and_system --single-branch https://github.com/fabriziotappero/ip-cores.git
