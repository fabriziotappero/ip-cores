...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: acex_1k50_board
    Project category: prototype_board
    Project branch: prototype_board_acex_1k50_board
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_acex_1k50_board --single-branch https://github.com/fabriziotappero/ip-cores.git
