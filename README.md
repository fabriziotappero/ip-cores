...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pci_card_with_xilinx_x3cs500e
    Project category: prototype_board
    Project branch: prototype_board_pci_card_with_xilinx_x3cs500e
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_pci_card_with_xilinx_x3cs500e --single-branch https://github.com/fabriziotappero/ip-cores.git
