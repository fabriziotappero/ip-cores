...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: motion_estimation_processor
    Project category: video_controller
    Project branch: video_controller_motion_estimation_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_motion_estimation_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
