...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_fir_filter_1
    Project category: dsp_core
    Project branch: dsp_core_generic_fir_filter_1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_generic_fir_filter_1 --single-branch https://github.com/fabriziotappero/ip-cores.git
