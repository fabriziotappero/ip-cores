...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: dsp_wishbone_compatible_cores
    Project category: dsp_core
    Project branch: dsp_core_dsp_wishbone_compatible_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_dsp_wishbone_compatible_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
