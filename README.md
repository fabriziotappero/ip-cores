...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: wishbone_interface_for_spi_flash
    Project category: memory_core
    Project branch: memory_core_wishbone_interface_for_spi_flash
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_wishbone_interface_for_spi_flash --single-branch https://github.com/fabriziotappero/ip-cores.git
