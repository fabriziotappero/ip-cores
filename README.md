...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rapidio_ip_library
    Project category: communication_controller
    Project branch: communication_controller_rapidio_ip_library
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_rapidio_ip_library --single-branch https://github.com/fabriziotappero/ip-cores.git
