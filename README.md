...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: fade-light_l3_ethernet_protocol_for_transmission_o
    Project category: communication_controller
    Project branch: communication_controller_fade-light_l3_ethernet_protocol_for_transmission_o
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_fade-light_l3_ethernet_protocol_for_transmission_o --single-branch https://github.com/fabriziotappero/ip-cores.git
