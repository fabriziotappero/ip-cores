...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: open_freelist
    Project category: memory_core
    Project branch: memory_core_open_freelist
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_open_freelist --single-branch https://github.com/fabriziotappero/ip-cores.git
