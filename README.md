...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: uart_to-from_fiber_optic
    Project category: communication_controller
    Project branch: communication_controller_uart_to-from_fiber_optic
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_uart_to-from_fiber_optic --single-branch https://github.com/fabriziotappero/ip-cores.git
