...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pipelined_dct-idct
    Project category: dsp_core
    Project branch: dsp_core_pipelined_dct-idct
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_pipelined_dct-idct --single-branch https://github.com/fabriziotappero/ip-cores.git
