...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ztex_usb-fpga_module_2.04
    Project category: prototype_board
    Project branch: prototype_board_ztex_usb-fpga_module_2.04
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_ztex_usb-fpga_module_2.04 --single-branch https://github.com/fabriziotappero/ip-cores.git
