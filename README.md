...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rtea_128-256
    Project category: crypto_core
    Project branch: crypto_core_rtea_128-256
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_rtea_128-256 --single-branch https://github.com/fabriziotappero/ip-cores.git
