...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ao68000-wishbone_68000_core
    Project category: processor
    Project branch: processor_ao68000-wishbone_68000_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_ao68000-wishbone_68000_core --single-branch https://github.com/fabriziotappero/ip-cores.git
