...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aspida_sync-async_dlx_core
    Project category: processor
    Project branch: processor_aspida_sync-async_dlx_core
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_aspida_sync-async_dlx_core --single-branch https://github.com/fabriziotappero/ip-cores.git
