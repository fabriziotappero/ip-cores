...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: simple_all_digital_fm_receiver
    Project category: other
    Project branch: other_simple_all_digital_fm_receiver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_simple_all_digital_fm_receiver --single-branch https://github.com/fabriziotappero/ip-cores.git
