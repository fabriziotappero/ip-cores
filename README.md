...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemc_to_verilog_synthesizable_subset_translator
    Project category: other
    Project branch: other_systemc_to_verilog_synthesizable_subset_translator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_systemc_to_verilog_synthesizable_subset_translator --single-branch https://github.com/fabriziotappero/ip-cores.git
