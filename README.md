...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: mod3_calc
    Project category: arithmetic_core
    Project branch: arithmetic_core_mod3_calc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_mod3_calc --single-branch https://github.com/fabriziotappero/ip-cores.git
