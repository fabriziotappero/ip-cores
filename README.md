...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: video_starter_kit
    Project category: video_controller
    Project branch: video_controller_video_starter_kit
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_video_starter_kit --single-branch https://github.com/fabriziotappero/ip-cores.git
