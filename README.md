...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: distributed_limited_cores
    Project category: processor
    Project branch: processor_distributed_limited_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_distributed_limited_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
