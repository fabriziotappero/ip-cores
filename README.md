...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: orsoc_graphics_accelerator
    Project category: arithmetic_core
    Project branch: arithmetic_core_orsoc_graphics_accelerator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_orsoc_graphics_accelerator --single-branch https://github.com/fabriziotappero/ip-cores.git
