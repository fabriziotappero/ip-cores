...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: hdlc_controller
    Project category: communication_controller
    Project branch: communication_controller_hdlc_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_hdlc_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
