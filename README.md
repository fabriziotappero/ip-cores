...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: video_stream_scaler
    Project category: video_controller
    Project branch: video_controller_video_stream_scaler
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_video_stream_scaler --single-branch https://github.com/fabriziotappero/ip-cores.git
