...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: quadrature_decoder_for_optical_encoders
    Project category: other
    Project branch: other_quadrature_decoder_for_optical_encoders
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_quadrature_decoder_for_optical_encoders --single-branch https://github.com/fabriziotappero/ip-cores.git
