...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ds1621_model
    Project category: testing-verification
    Project branch: testing-verification_ds1621_model
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_ds1621_model --single-branch https://github.com/fabriziotappero/ip-cores.git
