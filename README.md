...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: generic_apb_register_file
    Project category: system_on_chip
    Project branch: system_on_chip_generic_apb_register_file
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_generic_apb_register_file --single-branch https://github.com/fabriziotappero/ip-cores.git
