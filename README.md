...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: viterbi_decoder_axi4-stream_compliant
    Project category: ecc_core
    Project branch: ecc_core_viterbi_decoder_axi4-stream_compliant
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_viterbi_decoder_axi4-stream_compliant --single-branch https://github.com/fabriziotappero/ip-cores.git
