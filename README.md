...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: usb_fpga_module_1.11
    Project category: prototype_board
    Project branch: prototype_board_usb_fpga_module_1.11
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_usb_fpga_module_1.11 --single-branch https://github.com/fabriziotappero/ip-cores.git
