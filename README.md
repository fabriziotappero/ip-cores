...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: microsimplez
    Project category: processor
    Project branch: processor_microsimplez
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_microsimplez --single-branch https://github.com/fabriziotappero/ip-cores.git
