...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 5x4gbps_crc_generator_designed_with_standard_cells
    Project category: arithmetic_core
    Project branch: arithmetic_core_5x4gbps_crc_generator_designed_with_standard_cells
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_5x4gbps_crc_generator_designed_with_standard_cells --single-branch https://github.com/fabriziotappero/ip-cores.git
