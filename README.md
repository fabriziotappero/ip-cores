...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: iq_phase_and_gain_correction
    Project category: dsp_core
    Project branch: dsp_core_iq_phase_and_gain_correction
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_iq_phase_and_gain_correction --single-branch https://github.com/fabriziotappero/ip-cores.git
