...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: universal_programming_cable
    Project category: other
    Project branch: other_universal_programming_cable
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_universal_programming_cable --single-branch https://github.com/fabriziotappero/ip-cores.git
