...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nugroho_free_crypto_cores
    Project category: crypto_core
    Project branch: crypto_core_nugroho_free_crypto_cores
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_nugroho_free_crypto_cores --single-branch https://github.com/fabriziotappero/ip-cores.git
