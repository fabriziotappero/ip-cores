...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: serial_ata_host_bus_adapter_core_for_virtex_6
    Project category: communication_controller
    Project branch: communication_controller_serial_ata_host_bus_adapter_core_for_virtex_6
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_serial_ata_host_bus_adapter_core_for_virtex_6 --single-branch https://github.com/fabriziotappero/ip-cores.git
