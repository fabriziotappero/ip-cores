...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: logicprobe
    Project category: testing-verification
    Project branch: testing-verification_logicprobe
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b testing-verification_logicprobe --single-branch https://github.com/fabriziotappero/ip-cores.git
