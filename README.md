...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: versatile_io
    Project category: communication_controller
    Project branch: communication_controller_versatile_io
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_versatile_io --single-branch https://github.com/fabriziotappero/ip-cores.git
