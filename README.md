...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: time_slot_interchange_digital_switch
    Project category: communication_controller
    Project branch: communication_controller_time_slot_interchange_digital_switch
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_time_slot_interchange_digital_switch --single-branch https://github.com/fabriziotappero/ip-cores.git
