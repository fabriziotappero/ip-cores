...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sata_phy
    Project category: communication_controller
    Project branch: communication_controller_sata_phy
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_sata_phy --single-branch https://github.com/fabriziotappero/ip-cores.git
