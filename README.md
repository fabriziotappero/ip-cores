...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: turbo_decoder_1
    Project category: ecc_core
    Project branch: ecc_core_turbo_decoder_1
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b ecc_core_turbo_decoder_1 --single-branch https://github.com/fabriziotappero/ip-cores.git
