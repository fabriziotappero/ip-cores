...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rc6_cryptography
    Project category: crypto_core
    Project branch: crypto_core_rc6_cryptography
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_rc6_cryptography --single-branch https://github.com/fabriziotappero/ip-cores.git
