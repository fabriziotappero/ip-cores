...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ddr3_synthesizable_bfm
    Project category: memory_core
    Project branch: memory_core_ddr3_synthesizable_bfm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_ddr3_synthesizable_bfm --single-branch https://github.com/fabriziotappero/ip-cores.git
