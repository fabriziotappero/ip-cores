...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: turbo_8051
    Project category: processor
    Project branch: processor_turbo_8051
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_turbo_8051 --single-branch https://github.com/fabriziotappero/ip-cores.git
