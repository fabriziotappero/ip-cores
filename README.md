...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: sha1_secure_hash_algorithm
    Project category: crypto_core
    Project branch: crypto_core_sha1_secure_hash_algorithm
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_sha1_secure_hash_algorithm --single-branch https://github.com/fabriziotappero/ip-cores.git
