...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: systemc-verilog_random_number_generator
    Project category: other
    Project branch: other_systemc-verilog_random_number_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_systemc-verilog_random_number_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
