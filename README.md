...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: cpu_code_execution_timestamp
    Project category: coprocessor
    Project branch: coprocessor_cpu_code_execution_timestamp
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b coprocessor_cpu_code_execution_timestamp --single-branch https://github.com/fabriziotappero/ip-cores.git
