...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: multiple_switch_debouncer_in_vhdl
    Project category: other
    Project branch: other_multiple_switch_debouncer_in_vhdl
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_multiple_switch_debouncer_in_vhdl --single-branch https://github.com/fabriziotappero/ip-cores.git
