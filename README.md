...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: openmsp430
    Project category: processor
    Project branch: processor_openmsp430
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_openmsp430 --single-branch https://github.com/fabriziotappero/ip-cores.git
