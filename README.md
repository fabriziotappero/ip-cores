...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: spacewire
    Project category: communication_controller
    Project branch: communication_controller_spacewire
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_spacewire --single-branch https://github.com/fabriziotappero/ip-cores.git
