...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pipelined_synchronous_pulse_counter
    Project category: other
    Project branch: other_pipelined_synchronous_pulse_counter
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b other_pipelined_synchronous_pulse_counter --single-branch https://github.com/fabriziotappero/ip-cores.git
