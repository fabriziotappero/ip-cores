...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: floating-point_fft-ifft
    Project category: dsp_core
    Project branch: dsp_core_floating-point_fft-ifft
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b dsp_core_floating-point_fft-ifft --single-branch https://github.com/fabriziotappero/ip-cores.git
