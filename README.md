...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: lfsr-random_number_generator
    Project category: arithmetic_core
    Project branch: arithmetic_core_lfsr-random_number_generator
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b arithmetic_core_lfsr-random_number_generator --single-branch https://github.com/fabriziotappero/ip-cores.git
