...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: aes_rijndael
    Project category: crypto_core
    Project branch: crypto_core_aes_rijndael
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_aes_rijndael --single-branch https://github.com/fabriziotappero/ip-cores.git
