...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: 1g_ethernet_arp
    Project category: communication_controller
    Project branch: communication_controller_1g_ethernet_arp
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_1g_ethernet_arp --single-branch https://github.com/fabriziotappero/ip-cores.git
