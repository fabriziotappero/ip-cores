...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: rs232_system_controller
    Project category: system_controller
    Project branch: system_controller_rs232_system_controller
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_controller_rs232_system_controller --single-branch https://github.com/fabriziotappero/ip-cores.git
