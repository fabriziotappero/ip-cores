...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ooops-out-of-order_mips_tm_processor
    Project category: processor
    Project branch: processor_ooops-out-of-order_mips_tm_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_ooops-out-of-order_mips_tm_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
