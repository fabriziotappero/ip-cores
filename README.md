...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: madi_receiver
    Project category: communication_controller
    Project branch: communication_controller_madi_receiver
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_madi_receiver --single-branch https://github.com/fabriziotappero/ip-cores.git
