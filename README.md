...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: eus_fs-alice_ii-embeddable_single_board_computer
    Project category: prototype_board
    Project branch: prototype_board_eus_fs-alice_ii-embeddable_single_board_computer
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b prototype_board_eus_fs-alice_ii-embeddable_single_board_computer --single-branch https://github.com/fabriziotappero/ip-cores.git
