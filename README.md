...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: ssram_interface
    Project category: memory_core
    Project branch: memory_core_ssram_interface
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b memory_core_ssram_interface --single-branch https://github.com/fabriziotappero/ip-cores.git
