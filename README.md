...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: navr_avr_clone_8-bit_risc
    Project category: processor
    Project branch: processor_navr_avr_clone_8-bit_risc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_navr_avr_clone_8-bit_risc --single-branch https://github.com/fabriziotappero/ip-cores.git
