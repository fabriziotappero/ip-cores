...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: plasma-most_mips_itm_opcodes
    Project category: processor
    Project branch: processor_plasma-most_mips_itm_opcodes
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_plasma-most_mips_itm_opcodes --single-branch https://github.com/fabriziotappero/ip-cores.git
