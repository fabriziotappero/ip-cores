...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: pepelatz_misc
    Project category: processor
    Project branch: processor_pepelatz_misc
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_pepelatz_misc --single-branch https://github.com/fabriziotappero/ip-cores.git
