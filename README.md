...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: nanoblaze_the_expandable_processor
    Project category: processor
    Project branch: processor_nanoblaze_the_expandable_processor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b processor_nanoblaze_the_expandable_processor --single-branch https://github.com/fabriziotappero/ip-cores.git
