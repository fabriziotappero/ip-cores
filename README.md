...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: system05
    Project category: system_on_chip
    Project branch: system_on_chip_system05
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b system_on_chip_system05 --single-branch https://github.com/fabriziotappero/ip-cores.git
