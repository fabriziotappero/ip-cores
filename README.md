...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: bitcoin_double_sha256
    Project category: crypto_core
    Project branch: crypto_core_bitcoin_double_sha256
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b crypto_core_bitcoin_double_sha256 --single-branch https://github.com/fabriziotappero/ip-cores.git
