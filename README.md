...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: video_compression_systems
    Project category: video_controller
    Project branch: video_controller_video_compression_systems
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b video_controller_video_compression_systems --single-branch https://github.com/fabriziotappero/ip-cores.git
