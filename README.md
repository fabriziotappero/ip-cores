...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: m2g-media_oriented_systems_transport_most_ip_cor
    Project category: communication_controller
    Project branch: communication_controller_m2g-media_oriented_systems_transport_most_ip_cor
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_m2g-media_oriented_systems_transport_most_ip_cor --single-branch https://github.com/fabriziotappero/ip-cores.git
