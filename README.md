...
This branch contains the following VHDL/Verilog IP Code:
    ...
    Project name: opb-compatible_onewire_master
    Project category: communication_controller
    Project branch: communication_controller_opb-compatible_onewire_master
...
in. This branch can be downloaded with the git command.
    ...
    git clone -b communication_controller_opb-compatible_onewire_master --single-branch https://github.com/fabriziotappero/ip-cores.git
