...
# Create project
create_project kc705_10g3 ./kc705_10g3

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects kc705_10g3]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/kc705/kc705_fade_top.vhd"]"\
]
...
set file "$origin_dir/src/kc705/kc705_fade_top.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set obj [get_filesets sources_1]
set_property "top" "kc705_10g_2" $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/src/kc705/ack_fifo/ack_fifo.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/kc705/ack_fifo/ack_fifo.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/src/kc705/ila_1/ila_1.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/kc705/ila_1/ila_1.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "synth_checkpoint_mode" "Singular" $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/src/kc705/ten_gig_eth/ten_gig_eth_pcs_pma_0.xci"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/src/kc705/ten_gig_eth/ten_gig_eth_pcs_pma_0.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "synth_checkpoint_mode" "Singular" $file_obj
...
set file "[file normalize "$origin_dir/src/kc705/wzconstr.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src/kc705/wzconstr.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "$origin_dir/src/kc705/wzconstr.xdc" $obj
...
puts "INFO: Project created:kc705_10g3"
launch_runs synth_1
wait_on_run synth_1
launch_runs impl_1
wait_on_run impl_1
