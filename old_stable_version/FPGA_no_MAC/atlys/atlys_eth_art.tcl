...
proc add_source_files {} {
   ...
   xfile add "../src/common/PCK_CRC32_D8.vhd"
   xfile add "../src/common/desc_manager_simple.vhd"
   xfile add "../src/common/dpram_inf.vhd"
   xfile add "../src/common/eth_receiver8.vhd"
   xfile add "../src/common/eth_sender8.vhd"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/xl/ise_projects/ether_fpga_txt_new/FPGA/atlys/xst" -process "Synthesize - XST"
