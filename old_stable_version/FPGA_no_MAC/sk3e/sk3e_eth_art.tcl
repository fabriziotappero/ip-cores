...
proc add_source_files {} {
   ...
   xfile add "../src/common/PCK_CRC32_D4.vhd"
   xfile add "../src/common/dpram_inf.vhd"
   xfile add "../src/common/eth_receiver4.vhd"
   xfile add "../src/common/eth_sender4.vhd"
   xfile add "ack_fifo.xco"
   xfile add "desc_manager_simple.vhd"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/xl/ise_projects/ether_fpga_txt_new/FPGA/sk3e/xst" -process "Synthesize - XST"
