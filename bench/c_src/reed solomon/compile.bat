...
gcc  -O2 -O -DRTL_SIM -Dmain=main2 -Wall -S  rs_tak.c
gcc  -O2 -O -DRTL_SIM -Dmain=main2 -Wall -c -s rs_tak.c
ld.exe -Ttext 0 -eentry -Map test.map -s -N -o test.exe boot.o rs_tak.o 
