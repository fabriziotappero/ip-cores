...
as -o strcmp.o  strcmp.s
gcc  -O2 -O  -DRTL_SIM -Dmain=main2 -Wall -S  dhry21_tak.c
gcc  -O2 -O  -DRTL_SIM -Dmain=main2 -Wall -c -s dhry21_tak.c
ld.exe -Ttext 0 -eentry -Map test.map -s -N -o test.exe boot.o dhry21_tak.o strcmp.o
